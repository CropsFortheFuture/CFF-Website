 ...
 */
    ...
    class KBS_AquacropPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('no_season_caop_growth_coef');
            $this->dataset->AddField($field, false);
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('no_season_caop_growth_coef', $this->RenderText('No Season Caop Growth Coef')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for no_season_caop_growth_coef field
            //
            $column = new TextViewColumn('no_season_caop_growth_coef', 'No Season Caop Growth Coef', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for no_season_caop_growth_coef field
            //
            $editor = new TextEdit('no_season_caop_growth_coef_edit');
            $editColumn = new CustomEditColumn('No Season Caop Growth Coef', 'no_season_caop_growth_coef', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
