    ...
    class KBS_Crop_StatPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Statssearch', $this->dataset,
                array('statID', 'cropID', 'area_cultivated_max', 'area_cultivated_mean', 'area_cultivated_min', 'area_cultivated_unit', 'area_harvst_max', 'area_harvst_mean', 'area_harvst_min', 'area_harvst_unit', 'yield_max', 'yield_mean', 'yield_min', 'yield_unit', 'kbs_stat_others', 'info_id'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('statID', $this->RenderText('StatID')));
        ...
        {
            //
            // View column for statID field
            //
            $column = new TextViewColumn('statID', 'StatID', $this->dataset);
