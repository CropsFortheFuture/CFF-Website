 ...
 */
    ...
    class Info_KBS_SocioEconomy_HumanPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('human_knowledge_other');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_SocioEconomy_Humanasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('human_knowledge_other_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_SocioEconomy_Human_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_SocioEconomy_HumanGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_SocioEconomy_HumanPage("Info_KBS_SocioEconomy_Human.php", "Info_KBS_SocioEconomy_Human", GetCurrentUserGrantForDataSource("Info_KBS_SocioEconomy_Human"), 'UTF-8');
        $Page->SetShortCaption('Info KBS SocioEconomy Human');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS SocioEconomy Human');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_SocioEconomy_Human"));
