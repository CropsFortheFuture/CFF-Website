    ...
    class KBS_Agro_SeasonPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Agro_Seasonssearch', $this->dataset,
                array('cropID', 'season_1_year', 'season_2_year', 'season_3_year', 'season_all_year', 'season_semi_permanent', 'season_irrigated', 'season_irrig_rainfed', 'season_length_min', 'season_length_max', 'season_length_mean', 'season_rainfed', 'kbs_season_others'),
