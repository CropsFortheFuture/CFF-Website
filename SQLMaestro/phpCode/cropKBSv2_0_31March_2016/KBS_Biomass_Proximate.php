 ...
 */
    ...
    class KBS_Biomass_ProximatePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('biomass_ash_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_ash_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_ash_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_fixed_carbon_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_fixed_carbon_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_fixed_carbon_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_proximate_moisture_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_proximate_moisture_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_proximate_moisture_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_volatile_matter_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_volatile_matter_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_volatile_matter_mean');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_biompart_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Biomass_Proximatessearch', $this->dataset,
                array('cropID', 'biomass_ash_min', 'biomass_ash_max', 'biomass_ash_mean', 'biomass_fixed_carbon_min', 'biomass_fixed_carbon_max', 'biomass_fixed_carbon_mean', 'biomass_proximate_moisture_min', 'biomass_proximate_moisture_max', 'biomass_proximate_moisture_mean', 'biomass_volatile_matter_min', 'biomass_volatile_matter_max', 'biomass_volatile_matter_mean', 'kbs_biompart_others'),
                array($this->RenderText('CropID'), $this->RenderText('Biomass Ash Min'), $this->RenderText('Biomass Ash Max'), $this->RenderText('Biomass Ash Mean'), $this->RenderText('Biomass Fixed Carbon Min'), $this->RenderText('Biomass Fixed Carbon Max'), $this->RenderText('Biomass Fixed Carbon Mean'), $this->RenderText('Biomass Proximate Moisture Min'), $this->RenderText('Biomass Proximate Moisture Max'), $this->RenderText('Biomass Proximate Moisture Mean'), $this->RenderText('Biomass Volatile Matter Min'), $this->RenderText('Biomass Volatile Matter Max'), $this->RenderText('Biomass Volatile Matter Mean'), $this->RenderText('Kbs Biompart Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Biomass_Proximateasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_ash_min', $this->RenderText('Biomass Ash Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_ash_max', $this->RenderText('Biomass Ash Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_ash_mean', $this->RenderText('Biomass Ash Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_fixed_carbon_min', $this->RenderText('Biomass Fixed Carbon Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_fixed_carbon_max', $this->RenderText('Biomass Fixed Carbon Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_fixed_carbon_mean', $this->RenderText('Biomass Fixed Carbon Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_proximate_moisture_min', $this->RenderText('Biomass Proximate Moisture Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_proximate_moisture_max', $this->RenderText('Biomass Proximate Moisture Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_proximate_moisture_mean', $this->RenderText('Biomass Proximate Moisture Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_volatile_matter_min', $this->RenderText('Biomass Volatile Matter Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_volatile_matter_max', $this->RenderText('Biomass Volatile Matter Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_volatile_matter_mean', $this->RenderText('Biomass Volatile Matter Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_biompart_others', $this->RenderText('Kbs Biompart Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for biomass_ash_min field
            //
            $column = new TextViewColumn('biomass_ash_min', 'Biomass Ash Min', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for biomass_ash_max field
            //
            $column = new TextViewColumn('biomass_ash_max', 'Biomass Ash Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_ash_mean field
            //
            $column = new TextViewColumn('biomass_ash_mean', 'Biomass Ash Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_fixed_carbon_min field
            //
            $column = new TextViewColumn('biomass_fixed_carbon_min', 'Biomass Fixed Carbon Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_fixed_carbon_max field
            //
            $column = new TextViewColumn('biomass_fixed_carbon_max', 'Biomass Fixed Carbon Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_fixed_carbon_mean field
            //
            $column = new TextViewColumn('biomass_fixed_carbon_mean', 'Biomass Fixed Carbon Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_proximate_moisture_min field
            //
            $column = new TextViewColumn('biomass_proximate_moisture_min', 'Biomass Proximate Moisture Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_proximate_moisture_max field
            //
            $column = new TextViewColumn('biomass_proximate_moisture_max', 'Biomass Proximate Moisture Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_proximate_moisture_mean field
            //
            $column = new TextViewColumn('biomass_proximate_moisture_mean', 'Biomass Proximate Moisture Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_volatile_matter_min field
            //
            $column = new TextViewColumn('biomass_volatile_matter_min', 'Biomass Volatile Matter Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_volatile_matter_max field
            //
            $column = new TextViewColumn('biomass_volatile_matter_max', 'Biomass Volatile Matter Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_volatile_matter_mean field
            //
            $column = new TextViewColumn('biomass_volatile_matter_mean', 'Biomass Volatile Matter Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for kbs_biompart_others field
            //
            $column = new TextViewColumn('kbs_biompart_others', 'Kbs Biompart Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_ProximateGrid_kbs_biompart_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_ProximateGrid_kbs_biompart_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for biomass_ash_min field
            //
            $editor = new TextEdit('biomass_ash_min_edit');
            $editColumn = new CustomEditColumn('Biomass Ash Min', 'biomass_ash_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_ash_max field
            //
            $editor = new TextEdit('biomass_ash_max_edit');
            $editColumn = new CustomEditColumn('Biomass Ash Max', 'biomass_ash_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_ash_mean field
            //
            $editor = new TextEdit('biomass_ash_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Ash Mean', 'biomass_ash_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_fixed_carbon_min field
            //
            $editor = new TextEdit('biomass_fixed_carbon_min_edit');
            $editColumn = new CustomEditColumn('Biomass Fixed Carbon Min', 'biomass_fixed_carbon_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_fixed_carbon_max field
            //
            $editor = new TextEdit('biomass_fixed_carbon_max_edit');
            $editColumn = new CustomEditColumn('Biomass Fixed Carbon Max', 'biomass_fixed_carbon_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_fixed_carbon_mean field
            //
            $editor = new TextEdit('biomass_fixed_carbon_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Fixed Carbon Mean', 'biomass_fixed_carbon_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_proximate_moisture_min field
            //
            $editor = new TextEdit('biomass_proximate_moisture_min_edit');
            $editColumn = new CustomEditColumn('Biomass Proximate Moisture Min', 'biomass_proximate_moisture_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_proximate_moisture_max field
            //
            $editor = new TextEdit('biomass_proximate_moisture_max_edit');
            $editColumn = new CustomEditColumn('Biomass Proximate Moisture Max', 'biomass_proximate_moisture_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_proximate_moisture_mean field
            //
            $editor = new TextEdit('biomass_proximate_moisture_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Proximate Moisture Mean', 'biomass_proximate_moisture_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_volatile_matter_min field
            //
            $editor = new TextEdit('biomass_volatile_matter_min_edit');
            $editColumn = new CustomEditColumn('Biomass Volatile Matter Min', 'biomass_volatile_matter_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_volatile_matter_max field
            //
            $editor = new TextEdit('biomass_volatile_matter_max_edit');
            $editColumn = new CustomEditColumn('Biomass Volatile Matter Max', 'biomass_volatile_matter_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_volatile_matter_mean field
            //
            $editor = new TextEdit('biomass_volatile_matter_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Volatile Matter Mean', 'biomass_volatile_matter_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_biompart_others field
            //
            $editor = new TextAreaEdit('kbs_biompart_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Biompart Others', 'kbs_biompart_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Biomass_Proximate_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Biomass_ProximateGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_biompart_others', 'Kbs Biompart Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_ProximateGrid_kbs_biompart_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_biompart_others field
            //
            $column = new TextViewColumn('kbs_biompart_others', 'Kbs Biompart Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_ProximateGrid_kbs_biompart_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Biomass_ProximatePage("KBS_Biomass_Proximate.php", "KBS_Biomass_Proximate", GetCurrentUserGrantForDataSource("KBS_Biomass_Proximate"), 'UTF-8');
        $Page->SetShortCaption('KBS Biomass Proximate');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Biomass Proximate');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Biomass_Proximate"));
