 ...
 */
    ...
    class Info_KBS_Biomass_UlitmatePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_biomultimate_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Biomass_Ulitmatessearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Biomass_Ulitmateasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_biomultimate_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Biomass_Ulitmate_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Biomass_UlitmateGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Biomass_UlitmatePage("Info_KBS_Biomass_Ulitmate.php", "Info_KBS_Biomass_Ulitmate", GetCurrentUserGrantForDataSource("Info_KBS_Biomass_Ulitmate"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Biomass Ulitmate');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Biomass Ulitmate');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Biomass_Ulitmate"));
