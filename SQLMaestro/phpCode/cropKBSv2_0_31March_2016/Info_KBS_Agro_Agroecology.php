 ...
 */
    ...
    class Info_KBS_Agro_AgroecologyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_opt_li_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_opt_li_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_opt_li_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_abs_li_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_abs_li_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_abs_li_min');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_clim_zone');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_kiltemp_rest');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_kiltemp_earlygrowth');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_abio_toler');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_abio_suscept');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_intro_risk');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('agr_ecol_prdctn_system');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_agroecol_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Agro_Agroecologyssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Agroecologyasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_agroecol_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Agroecology_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_AgroecologyGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_AgroecologyPage("Info_KBS_Agro_Agroecology.php", "Info_KBS_Agro_Agroecology", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Agroecology"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Agroecology');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Agroecology');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Agroecology"));
