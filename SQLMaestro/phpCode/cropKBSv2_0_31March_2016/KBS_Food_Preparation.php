    ...
    class KBS_Food_PreparationPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Food_Preparationssearch', $this->dataset,
                array('cropID', 'prep_bake', 'prep_boiled', 'prep_complementary', 'prep_cooked', 'prep_garnish', 'prep_grilled', 'prep_ground', 'prep_raw_garnish', 'prep_staple', 'prep_steamed', 'kbs_foodprep_others'),
