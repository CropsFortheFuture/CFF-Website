 ...
 */
    ...
    class Info_KBS_SocioEconomy_SubsidyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_subsid_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_SocioEconomy_Subsidyssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_SocioEconomy_Subsidyasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_subsid_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_SocioEconomy_Subsidy_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_SocioEconomy_SubsidyGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_SocioEconomy_SubsidyPage("Info_KBS_SocioEconomy_Subsidy.php", "Info_KBS_SocioEconomy_Subsidy", GetCurrentUserGrantForDataSource("Info_KBS_SocioEconomy_Subsidy"), 'UTF-8');
        $Page->SetShortCaption('Info KBS SocioEconomy Subsidy');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS SocioEconomy Subsidy');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_SocioEconomy_Subsidy"));
