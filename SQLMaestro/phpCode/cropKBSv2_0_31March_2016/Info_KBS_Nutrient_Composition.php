 ...
 */
    ...
    class Info_KBS_Nutrient_CompositionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_ash_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_cho_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_energy_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_fibre_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_protein_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_sat_fat_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_unsat_fat_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('compos_water_unit');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('Moisture_content_unit');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_nutricomp_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Nutrient_Compositionssearch', $this->dataset,
                array('cropID', 'compos_ash_min', 'compos_ash_max', 'compos_ash_mean', 'compos_ash_unit', 'compos_cho_min', 'compos_cho_max', 'compos_cho_mean', 'compos_cho_unit', 'compos_energy_min', 'compos_energy_max', 'compos_energy_mean', 'compos_energy_unit', 'compos_fibre_min', 'compos_fibre_max', 'compos_fibre_mean', 'compos_fibre_unit', 'compos_protein_min', 'compos_protein_max', 'compos_protein_mean', 'compos_protein_unit', 'compos_sat_fat_min', 'compos_sat_fat_max', 'compos_sat_fat_mean', 'compos_sat_fat_unit', 'compos_unsat_fat_min', 'compos_unsat_fat_max', 'compos_unsat_fat_mean', 'compos_unsat_fat_unit', 'compos_water_min', 'compos_water_max', 'compos_water_mean', 'compos_water_unit', 'Moisture_content_min', 'Moisture_content_max', 'Moisture_content_mean', 'Moisture_content_unit', 'kbs_nutricomp_others'),
                array($this->RenderText('CropID'), $this->RenderText('Compos Ash Min'), $this->RenderText('Compos Ash Max'), $this->RenderText('Compos Ash Mean'), $this->RenderText('Compos Ash Unit'), $this->RenderText('Compos Cho Min'), $this->RenderText('Compos Cho Max'), $this->RenderText('Compos Cho Mean'), $this->RenderText('Compos Cho Unit'), $this->RenderText('Compos Energy Min'), $this->RenderText('Compos Energy Max'), $this->RenderText('Compos Energy Mean'), $this->RenderText('Compos Energy Unit'), $this->RenderText('Compos Fibre Min'), $this->RenderText('Compos Fibre Max'), $this->RenderText('Compos Fibre Mean'), $this->RenderText('Compos Fibre Unit'), $this->RenderText('Compos Protein Min'), $this->RenderText('Compos Protein Max'), $this->RenderText('Compos Protein Mean'), $this->RenderText('Compos Protein Unit'), $this->RenderText('Compos Sat Fat Min'), $this->RenderText('Compos Sat Fat Max'), $this->RenderText('Compos Sat Fat Mean'), $this->RenderText('Compos Sat Fat Unit'), $this->RenderText('Compos Unsat Fat Min'), $this->RenderText('Compos Unsat Fat Max'), $this->RenderText('Compos Unsat Fat Mean'), $this->RenderText('Compos Unsat Fat Unit'), $this->RenderText('Compos Water Min'), $this->RenderText('Compos Water Max'), $this->RenderText('Compos Water Mean'), $this->RenderText('Compos Water Unit'), $this->RenderText('Moisture Content Min'), $this->RenderText('Moisture Content Max'), $this->RenderText('Moisture Content Mean'), $this->RenderText('Moisture Content Unit'), $this->RenderText('Kbs Nutricomp Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Nutrient_Compositionasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_ash_unit', $this->RenderText('Compos Ash Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_cho_unit', $this->RenderText('Compos Cho Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_energy_unit', $this->RenderText('Compos Energy Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_fibre_unit', $this->RenderText('Compos Fibre Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_protein_unit', $this->RenderText('Compos Protein Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_sat_fat_unit', $this->RenderText('Compos Sat Fat Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_unsat_fat_unit', $this->RenderText('Compos Unsat Fat Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('compos_water_unit', $this->RenderText('Compos Water Unit')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Moisture_content_unit', $this->RenderText('Moisture Content Unit')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for compos_ash_unit field
            //
            $column = new TextViewColumn('compos_ash_unit', 'Compos Ash Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_cho_unit field
            //
            $column = new TextViewColumn('compos_cho_unit', 'Compos Cho Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_energy_unit field
            //
            $column = new TextViewColumn('compos_energy_unit', 'Compos Energy Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_fibre_unit field
            //
            $column = new TextViewColumn('compos_fibre_unit', 'Compos Fibre Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_protein_unit field
            //
            $column = new TextViewColumn('compos_protein_unit', 'Compos Protein Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_sat_fat_unit field
            //
            $column = new TextViewColumn('compos_sat_fat_unit', 'Compos Sat Fat Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_unsat_fat_unit field
            //
            $column = new TextViewColumn('compos_unsat_fat_unit', 'Compos Unsat Fat Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for compos_water_unit field
            //
            $column = new TextViewColumn('compos_water_unit', 'Compos Water Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for Moisture_content_unit field
            //
            $column = new TextViewColumn('Moisture_content_unit', 'Moisture Content Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for compos_ash_unit field
            //
            $editor = new TextEdit('compos_ash_unit_edit');
            $editColumn = new CustomEditColumn('Compos Ash Unit', 'compos_ash_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_cho_unit field
            //
            $editor = new TextEdit('compos_cho_unit_edit');
            $editColumn = new CustomEditColumn('Compos Cho Unit', 'compos_cho_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_energy_unit field
            //
            $editor = new TextEdit('compos_energy_unit_edit');
            $editColumn = new CustomEditColumn('Compos Energy Unit', 'compos_energy_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_fibre_unit field
            //
            $editor = new TextEdit('compos_fibre_unit_edit');
            $editColumn = new CustomEditColumn('Compos Fibre Unit', 'compos_fibre_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_protein_unit field
            //
            $editor = new TextEdit('compos_protein_unit_edit');
            $editColumn = new CustomEditColumn('Compos Protein Unit', 'compos_protein_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_sat_fat_unit field
            //
            $editor = new TextEdit('compos_sat_fat_unit_edit');
            $editColumn = new CustomEditColumn('Compos Sat Fat Unit', 'compos_sat_fat_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_unsat_fat_unit field
            //
            $editor = new TextEdit('compos_unsat_fat_unit_edit');
            $editColumn = new CustomEditColumn('Compos Unsat Fat Unit', 'compos_unsat_fat_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for compos_water_unit field
            //
            $editor = new TextEdit('compos_water_unit_edit');
            $editColumn = new CustomEditColumn('Compos Water Unit', 'compos_water_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for Moisture_content_unit field
            //
            $editor = new TextEdit('moisture_content_unit_edit');
            $editColumn = new CustomEditColumn('Moisture Content Unit', 'Moisture_content_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new TextEdit('kbs_nutricomp_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Nutrient_Composition_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Nutrient_CompositionGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Nutrient_CompositionPage("Info_KBS_Nutrient_Composition.php", "Info_KBS_Nutrient_Composition", GetCurrentUserGrantForDataSource("Info_KBS_Nutrient_Composition"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Nutrient Composition');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Nutrient Composition');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Nutrient_Composition"));
