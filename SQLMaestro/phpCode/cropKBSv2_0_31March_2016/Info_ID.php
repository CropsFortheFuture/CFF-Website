 ...
 */
    ...
    class Info_IDPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_IDssearch', $this->dataset,
                array('info_ID'),
                array($this->RenderText('Info ID')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_IDasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'Info_ID_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_IDGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_IDPage("Info_ID.php", "Info_ID", GetCurrentUserGrantForDataSource("Info_ID"), 'UTF-8');
        $Page->SetShortCaption('Info ID');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info ID');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_ID"));
