...
{
    $result = array('GENERAL', 'Agro', 'Food', 'Biomass', 'SocioEconomy', 'Crop Specific', 'Crop Metadata', 'Global Info', 'Aquacrop', 'Ecocrop', 'Food Plants International');
    return $result;
}
...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'KBS Metadata Tables Columns', 'short_caption' => 'KBS Metadata Tables Columns', 'filename' => 'KBS_Metadata_tables_columns.php', 'name' => 'KBS_Metadata_tables_columns', 'group_name' => 'Crop Metadata', 'add_separator' => false);
    $result[] = array('caption' => 'KBS Global Accuracy Color', 'short_caption' => 'KBS Global Accuracy Color', 'filename' => 'KBS_Global_Accuracy_Color.php', 'name' => 'KBS_Global_Accuracy_Color', 'group_name' => 'Global Info', 'add_separator' => false);
    $result[] = array('caption' => 'Food Plants International', 'short_caption' => 'Food Plants International', 'filename' => 'food_plants_international.php', 'name' => 'food_plants_international', 'group_name' => 'Food Plants International', 'add_separator' => false);
    return $result;
}
