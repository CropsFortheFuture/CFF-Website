 ...
 */
    ...
    class KBS_Food_PreparationPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('prep_bake');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_boiled');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_complementary');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_cooked');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_garnish');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_grilled');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_ground');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_raw_garnish');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_staple');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('prep_steamed');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_foodprep_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Food_Preparationssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'prep_bake', 'prep_boiled', 'prep_complementary', 'prep_cooked', 'prep_garnish', 'prep_grilled', 'prep_ground', 'prep_raw_garnish', 'prep_staple', 'prep_steamed', 'kbs_foodprep_others'),
                array($this->RenderText('CropID'), $this->RenderText('Prep Bake'), $this->RenderText('Prep Boiled'), $this->RenderText('Prep Complementary'), $this->RenderText('Prep Cooked'), $this->RenderText('Prep Garnish'), $this->RenderText('Prep Grilled'), $this->RenderText('Prep Ground'), $this->RenderText('Prep Raw Garnish'), $this->RenderText('Prep Staple'), $this->RenderText('Prep Steamed'), $this->RenderText('Kbs Foodprep Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Food_Preparationasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_bake', $this->RenderText('Prep Bake')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_boiled', $this->RenderText('Prep Boiled')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_complementary', $this->RenderText('Prep Complementary')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_cooked', $this->RenderText('Prep Cooked')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_garnish', $this->RenderText('Prep Garnish')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_grilled', $this->RenderText('Prep Grilled')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_ground', $this->RenderText('Prep Ground')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_raw_garnish', $this->RenderText('Prep Raw Garnish')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_staple', $this->RenderText('Prep Staple')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prep_steamed', $this->RenderText('Prep Steamed')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_foodprep_others', $this->RenderText('Kbs Foodprep Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for prep_bake field
            //
            $column = new TextViewColumn('prep_bake', 'Prep Bake', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_boiled field
            //
            $column = new TextViewColumn('prep_boiled', 'Prep Boiled', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_complementary field
            //
            $column = new TextViewColumn('prep_complementary', 'Prep Complementary', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_cooked field
            //
            $column = new TextViewColumn('prep_cooked', 'Prep Cooked', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_garnish field
            //
            $column = new TextViewColumn('prep_garnish', 'Prep Garnish', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_grilled field
            //
            $column = new TextViewColumn('prep_grilled', 'Prep Grilled', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_ground field
            //
            $column = new TextViewColumn('prep_ground', 'Prep Ground', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_raw_garnish field
            //
            $column = new TextViewColumn('prep_raw_garnish', 'Prep Raw Garnish', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_staple field
            //
            $column = new TextViewColumn('prep_staple', 'Prep Staple', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for prep_steamed field
            //
            $column = new TextViewColumn('prep_steamed', 'Prep Steamed', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_foodprep_others field
            //
            $column = new TextViewColumn('kbs_foodprep_others', 'Kbs Foodprep Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Food_PreparationGrid_kbs_foodprep_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Food_PreparationGrid_kbs_foodprep_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for prep_bake field
            //
            $editor = new TextEdit('prep_bake_edit');
            $editColumn = new CustomEditColumn('Prep Bake', 'prep_bake', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_boiled field
            //
            $editor = new TextEdit('prep_boiled_edit');
            $editColumn = new CustomEditColumn('Prep Boiled', 'prep_boiled', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_complementary field
            //
            $editor = new TextEdit('prep_complementary_edit');
            $editColumn = new CustomEditColumn('Prep Complementary', 'prep_complementary', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_cooked field
            //
            $editor = new TextEdit('prep_cooked_edit');
            $editColumn = new CustomEditColumn('Prep Cooked', 'prep_cooked', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_garnish field
            //
            $editor = new TextEdit('prep_garnish_edit');
            $editColumn = new CustomEditColumn('Prep Garnish', 'prep_garnish', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_grilled field
            //
            $editor = new TextEdit('prep_grilled_edit');
            $editColumn = new CustomEditColumn('Prep Grilled', 'prep_grilled', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_ground field
            //
            $editor = new TextEdit('prep_ground_edit');
            $editColumn = new CustomEditColumn('Prep Ground', 'prep_ground', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_raw_garnish field
            //
            $editor = new TextEdit('prep_raw_garnish_edit');
            $editColumn = new CustomEditColumn('Prep Raw Garnish', 'prep_raw_garnish', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_staple field
            //
            $editor = new TextEdit('prep_staple_edit');
            $editColumn = new CustomEditColumn('Prep Staple', 'prep_staple', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for prep_steamed field
            //
            $editor = new TextEdit('prep_steamed_edit');
            $editColumn = new CustomEditColumn('Prep Steamed', 'prep_steamed', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_foodprep_others field
            //
            $editor = new TextAreaEdit('kbs_foodprep_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Foodprep Others', 'kbs_foodprep_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Food_Preparation_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Food_PreparationGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_foodprep_others', 'Kbs Foodprep Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Food_PreparationGrid_kbs_foodprep_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_foodprep_others field
            //
            $column = new TextViewColumn('kbs_foodprep_others', 'Kbs Foodprep Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Food_PreparationGrid_kbs_foodprep_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Food_PreparationPage("KBS_Food_Preparation.php", "KBS_Food_Preparation", GetCurrentUserGrantForDataSource("KBS_Food_Preparation"), 'UTF-8');
        $Page->SetShortCaption('KBS Food Preparation');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Food Preparation');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Food_Preparation"));
