 ...
 */
    ...
    class KBS_General_PartsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('part_petiole');
            $this->dataset->AddField($field, false);
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Partsssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'part_bark', 'part_bulb', 'part_flower', 'part_fruits', 'part_grain', 'part_leaf', 'part_petiole', 'part_root', 'part_seed', 'part_stem', 'part_tuber', 'part_whole', 'part_wood', 'kbs_part_others'),
                array($this->RenderText('CropID'), $this->RenderText('Part Bark'), $this->RenderText('Part Bulb'), $this->RenderText('Part Flower'), $this->RenderText('Part Fruits'), $this->RenderText('Part Grain'), $this->RenderText('Part Leaf'), $this->RenderText('Part Petiole'), $this->RenderText('Part Root'), $this->RenderText('Part Seed'), $this->RenderText('Part Stem'), $this->RenderText('Part Tuber'), $this->RenderText('Part Whole'), $this->RenderText('Part Wood'), $this->RenderText('Kbs Part Others')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('part_petiole', $this->RenderText('Part Petiole')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for part_petiole field
            //
            $column = new TextViewColumn('part_petiole', 'Part Petiole', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new CheckBox('part_bark_edit');
            ...
            //
            $editor = new CheckBox('part_bulb_edit');
            ...
            //
            $editor = new CheckBox('part_flower_edit');
            ...
            //
            $editor = new CheckBox('part_fruits_edit');
            ...
            //
            $editor = new CheckBox('part_grain_edit');
            ...
            //
            $editor = new CheckBox('part_leaf_edit');
            ...
            //
            // Edit column for part_petiole field
            //
            $editor = new CheckBox('part_petiole_edit');
            $editColumn = new CustomEditColumn('Part Petiole', 'part_petiole', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new CheckBox('part_root_edit');
            ...
            //
            $editor = new CheckBox('part_seed_edit');
            ...
            //
            $editor = new CheckBox('part_stem_edit');
            ...
            //
            $editor = new CheckBox('part_tuber_edit');
            ...
            //
            $editor = new CheckBox('part_whole_edit');
            ...
            //
            $editor = new CheckBox('part_wood_edit');
