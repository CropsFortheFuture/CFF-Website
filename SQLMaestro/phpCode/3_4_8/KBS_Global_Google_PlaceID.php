 ...
 */
    ...
    class KBS_Global_Google_PlaceIDPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Global_Google_PlaceIDssearch', $this->dataset,
                array('id', 'google_place_id', 'google_address'),
                array($this->RenderText('Id'), $this->RenderText('Google Place Id'), $this->RenderText('Google Address')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Global_Google_PlaceIDasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('google_place_id', $this->RenderText('Google Place Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('google_address', $this->RenderText('Google Address')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('google_place_id', 'Google Place Id', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new TextViewColumn('google_address', 'Google Address', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_Google_PlaceIDGrid_google_address_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_Google_PlaceIDGrid_google_address_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Global_Google_PlaceID_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Global_Google_PlaceIDGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('google_address', 'Google Address', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_Google_PlaceIDGrid_google_address_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for google_address field
            //
            $column = new TextViewColumn('google_address', 'Google Address', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_Google_PlaceIDGrid_google_address_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Global_Google_PlaceIDPage("KBS_Global_Google_PlaceID.php", "KBS_Global_Google_PlaceID", GetCurrentUserGrantForDataSource("KBS_Global_Google_PlaceID"), 'UTF-8');
        $Page->SetShortCaption('KBS Global Google PlaceID');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Global Google PlaceID');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Global_Google_PlaceID"));
