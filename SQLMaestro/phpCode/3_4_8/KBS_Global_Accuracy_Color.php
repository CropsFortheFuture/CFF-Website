 ...
 */
    ...
    class KBS_Global_Accuracy_ColorPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Global_Accuracy_Colorssearch', $this->dataset,
                array('id', 'flag_color'),
                array($this->RenderText('Id'), $this->RenderText('Flag Color')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Global_Accuracy_Colorasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('flag_color', $this->RenderText('Flag Color')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('flag_color', 'Flag Color', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for flag_color field
            //
            $editor = new TextEdit('flag_color_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Flag Color', 'flag_color', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Global_Accuracy_Color_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Global_Accuracy_ColorGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new KBS_Global_Accuracy_ColorPage("KBS_Global_Accuracy_Color.php", "KBS_Global_Accuracy_Color", GetCurrentUserGrantForDataSource("KBS_Global_Accuracy_Color"), 'UTF-8');
        $Page->SetShortCaption('KBS Global Accuracy Color');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Global Accuracy Color');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Global_Accuracy_Color"));
