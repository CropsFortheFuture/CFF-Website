    ...
    class KBS_Crop_GermplasmPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Germplasmssearch', $this->dataset,
                array('germplasm_id', 'institute_id', 'cropID', 'germp_inst_name', 'germp_type_line', 'germp_type_landrce', 'germp_type_genotype', 'germp_type_cross', 'germp_no_accessions', 'germp_field_data_avlble', 'metadata_id'),
