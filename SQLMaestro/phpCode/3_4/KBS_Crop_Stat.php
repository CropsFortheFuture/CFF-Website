    ...
    class KBS_Crop_StatPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Statssearch', $this->dataset,
                array('statID', 'cropID', 'area_cultivated_max', 'area_cultivated_mean', 'area_cultivated_min', 'area_harvst_max', 'area_harvst_mean', 'area_harvst_min', 'yield_max', 'yield_mean', 'yield_min', 'kbs_stat_others', 'metadata_id'),
