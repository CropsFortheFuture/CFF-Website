    ...
    class KBS_General_PartsPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Partsssearch', $this->dataset,
                array('cropID', 'part_bark', 'part_bulb', 'part_flower', 'part_fruits', 'part_grain', 'part_leaf', 'part_petiole', 'part_root', 'part_seed', 'part_stem', 'part_tuber', 'part_whole', 'part_wood', 'kbs_part_others'),
