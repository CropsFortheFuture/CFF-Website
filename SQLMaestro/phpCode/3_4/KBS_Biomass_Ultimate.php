 ...
 */
    ...
    class KBS_Biomass_UltimatePage extends Page
    {
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Biomass_Ultimateasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('KBS_Biomass_UltimateGrid_kbs_biomultimate_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_UltimateGrid_kbs_biomultimate_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Biomass_Ultimate_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Biomass_UltimateGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_biomultimate_others', 'Kbs Biomultimate Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_UltimateGrid_kbs_biomultimate_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_biomultimate_others field
            //
            $column = new TextViewColumn('kbs_biomultimate_others', 'Kbs Biomultimate Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_UltimateGrid_kbs_biomultimate_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Biomass_UltimatePage("KBS_Biomass_Ultimate.php", "KBS_Biomass_Ultimate", GetCurrentUserGrantForDataSource("KBS_Biomass_Ultimate"), 'UTF-8');
        $Page->SetShortCaption('KBS Biomass Ultimate');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Biomass Ultimate');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Biomass_Ultimate"));
