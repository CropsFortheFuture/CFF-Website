    ...
    class KBS_General_Growth_CyclePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Growth_Cyclessearch', $this->dataset,
                array('cropID', 'growth_cycle_annual', 'growth_cycle_biannual', 'growth_cycle_perennial', 'growth_cycle_other', 'kbs_gc_others'),
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('growth_cycle_perennial_edit');
