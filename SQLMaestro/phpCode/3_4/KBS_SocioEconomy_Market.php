    ...
    class KBS_SocioEconomy_MarketPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_SocioEconomy_Marketssearch', $this->dataset,
                array('cropID', 'location_ID', 'market_seedsorce_formalcertpublic', 'market_seedsorce_formalcertprivate', 'market_seedsorce_formaluncertprivate', 'market_seedsorce_informalprivate', 'market_seedsorce_informalexchange', 'market_seedsorce_ownretained', 'kbs_market_others'),
