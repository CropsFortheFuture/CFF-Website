    ...
    class KBS_Global_WeedsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Global_Weeds`');
            $field = new IntegerField('weed_id');
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Global_Weedsssearch', $this->dataset,
                array('weed_id', 'weed_sci_name', 'weed_name', 'info_id'),
                array($this->RenderText('Weed Id'), $this->RenderText('Weed Sci Name'), $this->RenderText('Weed Name'), $this->RenderText('Info Id')),
                array(
