 ...
 */
    ...
    class KBS_Agro_SeasonPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new DateField('planting_date');
            $this->dataset->AddField($field, false);
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Agro_Seasonssearch', $this->dataset,
                array('id', 'cropID_name_var_lndrce', 'location_id', 'planting_date', 'season_length_min', 'season_length_max', 'season_length_mean', 'kbs_season_others'),
                array($this->RenderText('Id'), $this->RenderText('CropID'), $this->RenderText('Location Id'), $this->RenderText('Planting Date'), $this->RenderText('Season Length Min'), $this->RenderText('Season Length Max'), $this->RenderText('Season Length Mean'), $this->RenderText('Kbs Season Others')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('planting_date', $this->RenderText('Planting Date'), 'Y-m-d'));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for planting_date field
            //
            $column = new DateTimeViewColumn('planting_date', 'Planting Date', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for planting_date field
            //
            $editor = new DateTimeEdit('planting_date_edit', false, 'Y-m-d H:i:s', GetFirstDayOfWeek());
            $editColumn = new CustomEditColumn('Planting Date', 'planting_date', $editor, $this->dataset);
