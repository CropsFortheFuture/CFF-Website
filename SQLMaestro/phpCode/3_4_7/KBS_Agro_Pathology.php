 ...
 */
    ...
    class KBS_Agro_PathologyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('cropID', 'KBS_General', new StringField('name_var_lndrce'), new StringField('name_var_lndrce', 'cropID_name_var_lndrce', 'cropID_name_var_lndrce_KBS_General'), 'cropID_name_var_lndrce_KBS_General');
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('cropID', $this->RenderText('CropID'), $lookupDataset, 'name_var_lndrce', 'name_var_lndrce', false, 8));
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'cropID', 
                $editor, 
                $this->dataset, 'name_var_lndrce', 'name_var_lndrce', $lookupDataset);
            ...
            //
            $editor = new CheckBox('disease_contr_agronomic_edit');
            ...
            //
            $editor = new CheckBox('disease_contr_biological_edit');
            ...
            //
            $editor = new CheckBox('disease_contr_chemical_edit');
            ...
            //
            $editor = new CheckBox('disease_contr_integrated_edit');
            ...
            //
            $editor = new CheckBox('disease_manage_edit');
            ...
            //
            $editor = new CheckBox('pest_contr_agronomic_edit');
            ...
            //
            $editor = new CheckBox('pest_contr_biological_edit');
            ...
            //
            $editor = new CheckBox('pest_contr_chemical_edit');
            ...
            //
            $editor = new CheckBox('pest_contr_integrated_edit');
            ...
            //
            $editor = new CheckBox('pest_manage_edit');
            ...
            //
            $editor = new CheckBox('weed_contr_agronomic_edit');
            ...
            //
            $editor = new CheckBox('weed_contr_biological_edit');
            ...
            //
            $editor = new CheckBox('weed_contr_chemical_edit');
            ...
            //
            $editor = new CheckBox('weed_contr_integrated_edit');
            ...
            //
            $editor = new CheckBox('weed_manage_edit');
