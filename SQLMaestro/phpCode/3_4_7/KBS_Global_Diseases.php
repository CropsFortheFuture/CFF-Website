 ...
 */
    ...
    class KBS_Global_DiseasesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Global_Diseases`');
            $field = new IntegerField('disease_id', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Global_Diseasesssearch', $this->dataset,
                array('disease_id', 'disease_sci_name', 'disease_name', 'metadata_id'),
                array($this->RenderText('Disease Id'), $this->RenderText('Disease Sci Name'), $this->RenderText('Disease Name'), $this->RenderText('Metadata Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Global_Diseasesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasesGrid_disease_sci_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasesGrid_disease_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasesGrid_disease_sci_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasesGrid_disease_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Global_Diseases_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Global_DiseasesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('disease_sci_name', 'Disease Sci Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasesGrid_disease_sci_name_handler_list', $column);
            ...
            $column = new TextViewColumn('disease_name', 'Disease Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasesGrid_disease_name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for disease_sci_name field
            //
            $column = new TextViewColumn('disease_sci_name', 'Disease Sci Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasesGrid_disease_sci_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for disease_name field
            //
            $column = new TextViewColumn('disease_name', 'Disease Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasesGrid_disease_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Global_DiseasesPage("KBS_Global_Diseases.php", "KBS_Global_Diseases", GetCurrentUserGrantForDataSource("KBS_Global_Diseases"), 'UTF-8');
        $Page->SetShortCaption('KBS Global Diseases');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Global Diseases');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Global_Diseases"));
