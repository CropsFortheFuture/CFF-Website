 ...
 */
    ...
    class KBS_Crop_DiseasesPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Diseasesssearch', $this->dataset,
                array('disease_id', 'cropID_name_var_lndrce', 'metadata_id'),
                array($this->RenderText('Disease Id'), $this->RenderText('CropID'), $this->RenderText('Metadata Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Crop_Diseasesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Crop_Diseases_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Crop_DiseasesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new KBS_Crop_DiseasesPage("KBS_Crop_Diseases.php", "KBS_Crop_Diseases", GetCurrentUserGrantForDataSource("KBS_Crop_Diseases"), 'UTF-8');
        $Page->SetShortCaption('KBS Crop Diseases');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Crop Diseases');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Crop_Diseases"));
