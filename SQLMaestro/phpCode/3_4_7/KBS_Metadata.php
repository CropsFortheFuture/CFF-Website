    ...
    class KBS_MetadataPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Metadatassearch', $this->dataset,
                array('id', 'cropid_name_var_lndrce', 'location_id_google_address', 'ref1', 'src1', 'ref2', 'src2', 'ref3', 'src3', 'ref4', 'src4', 'ref5', 'src5', 'ref6', 'src6', 'ref7', 'src7', 'ref8', 'src8', 'ref9', 'src9', 'ref10', 'src10', 'note', 'acc_flag_flag_color', 'approval_flag', 'contributor', 'coverage', 'creator', 'date', 'description', 'format', 'identifier', 'language', 'publisher', 'relation', 'rights', 'source', 'subject', 'title', 'type', 'image', 'document', 'table_col_id_table_col_name'),
