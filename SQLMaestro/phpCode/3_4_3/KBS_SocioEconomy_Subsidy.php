    ...
    class KBS_SocioEconomy_SubsidyPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_SocioEconomy_Subsidyssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'location_ID', 'subsdy_public_support', 'subsdy_drct_pymnt_prod', 'subsdy_fertiliser', 'subsdy_seed', 'subsdy_extension_advice', 'subsdy_equipmnts_tools', 'subsdy_marketing_help', 'subsdy_pkg_prcss_help', 'kbs_subsid_others'),
