 ...
 */
    ...
    class KBS_General_Growth_HabitPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_General_Growth_Habit`');
            $field = new IntegerField('cropID');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('growth_habit_forb');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_graminoid');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_liana');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_lichenous');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_nonvascular');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_shrub');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_subshrub');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_tree');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_habit_vine');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_gh_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_General_Growth_Habitssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'growth_habit_forb', 'growth_habit_graminoid', 'growth_habit_liana', 'growth_habit_lichenous', 'growth_habit_nonvascular', 'growth_habit_shrub', 'growth_habit_subshrub', 'growth_habit_tree', 'growth_habit_vine', 'kbs_gh_others'),
                array($this->RenderText('CropID'), $this->RenderText('Growth Habit Forb'), $this->RenderText('Growth Habit Graminoid'), $this->RenderText('Growth Habit Liana'), $this->RenderText('Growth Habit Lichenous'), $this->RenderText('Growth Habit Nonvascular'), $this->RenderText('Growth Habit Shrub'), $this->RenderText('Growth Habit Subshrub'), $this->RenderText('Growth Habit Tree'), $this->RenderText('Growth Habit Vine'), $this->RenderText('Kbs Gh Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_General_Growth_Habitasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_forb', $this->RenderText('Growth Habit Forb')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_graminoid', $this->RenderText('Growth Habit Graminoid')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_liana', $this->RenderText('Growth Habit Liana')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_lichenous', $this->RenderText('Growth Habit Lichenous')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_nonvascular', $this->RenderText('Growth Habit Nonvascular')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_shrub', $this->RenderText('Growth Habit Shrub')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_subshrub', $this->RenderText('Growth Habit Subshrub')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_tree', $this->RenderText('Growth Habit Tree')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_habit_vine', $this->RenderText('Growth Habit Vine')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_gh_others', $this->RenderText('Kbs Gh Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for growth_habit_forb field
            //
            $column = new TextViewColumn('growth_habit_forb', 'Growth Habit Forb', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_graminoid field
            //
            $column = new TextViewColumn('growth_habit_graminoid', 'Growth Habit Graminoid', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_liana field
            //
            $column = new TextViewColumn('growth_habit_liana', 'Growth Habit Liana', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_lichenous field
            //
            $column = new TextViewColumn('growth_habit_lichenous', 'Growth Habit Lichenous', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_nonvascular field
            //
            $column = new TextViewColumn('growth_habit_nonvascular', 'Growth Habit Nonvascular', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_shrub field
            //
            $column = new TextViewColumn('growth_habit_shrub', 'Growth Habit Shrub', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_subshrub field
            //
            $column = new TextViewColumn('growth_habit_subshrub', 'Growth Habit Subshrub', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_tree field
            //
            $column = new TextViewColumn('growth_habit_tree', 'Growth Habit Tree', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for growth_habit_vine field
            //
            $column = new TextViewColumn('growth_habit_vine', 'Growth Habit Vine', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_gh_others field
            //
            $column = new TextViewColumn('kbs_gh_others', 'Kbs Gh Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_General_Growth_HabitGrid_kbs_gh_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_General_Growth_HabitGrid_kbs_gh_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for growth_habit_forb field
            //
            $editor = new TextEdit('growth_habit_forb_edit');
            $editColumn = new CustomEditColumn('Growth Habit Forb', 'growth_habit_forb', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_graminoid field
            //
            $editor = new TextEdit('growth_habit_graminoid_edit');
            $editColumn = new CustomEditColumn('Growth Habit Graminoid', 'growth_habit_graminoid', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_liana field
            //
            $editor = new TextEdit('growth_habit_liana_edit');
            $editColumn = new CustomEditColumn('Growth Habit Liana', 'growth_habit_liana', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_lichenous field
            //
            $editor = new TextEdit('growth_habit_lichenous_edit');
            $editColumn = new CustomEditColumn('Growth Habit Lichenous', 'growth_habit_lichenous', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_nonvascular field
            //
            $editor = new TextEdit('growth_habit_nonvascular_edit');
            $editColumn = new CustomEditColumn('Growth Habit Nonvascular', 'growth_habit_nonvascular', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_shrub field
            //
            $editor = new TextEdit('growth_habit_shrub_edit');
            $editColumn = new CustomEditColumn('Growth Habit Shrub', 'growth_habit_shrub', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_subshrub field
            //
            $editor = new TextEdit('growth_habit_subshrub_edit');
            $editColumn = new CustomEditColumn('Growth Habit Subshrub', 'growth_habit_subshrub', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_tree field
            //
            $editor = new TextEdit('growth_habit_tree_edit');
            $editColumn = new CustomEditColumn('Growth Habit Tree', 'growth_habit_tree', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for growth_habit_vine field
            //
            $editor = new TextEdit('growth_habit_vine_edit');
            $editColumn = new CustomEditColumn('Growth Habit Vine', 'growth_habit_vine', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_gh_others field
            //
            $editor = new TextAreaEdit('kbs_gh_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Gh Others', 'kbs_gh_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_General_Growth_Habit_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_General_Growth_HabitGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_gh_others', 'Kbs Gh Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_General_Growth_HabitGrid_kbs_gh_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_gh_others field
            //
            $column = new TextViewColumn('kbs_gh_others', 'Kbs Gh Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_General_Growth_HabitGrid_kbs_gh_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_General_Growth_HabitPage("KBS_General_Growth_Habit.php", "KBS_General_Growth_Habit", GetCurrentUserGrantForDataSource("KBS_General_Growth_Habit"), 'UTF-8');
        $Page->SetShortCaption('KBS General Growth Habit');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS General Growth Habit');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_General_Growth_Habit"));
