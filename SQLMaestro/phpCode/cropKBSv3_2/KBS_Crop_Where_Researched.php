 ...
 */
    ...
    class KBS_Crop_Where_ResearchedPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('where_researched_id');
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Where_Researchedssearch', $this->dataset,
                array('where_researched_id', 'institute_id', 'cropID_name_var_lndrce', 'where_researched', 'info_id'),
                array($this->RenderText('Where Researched Id'), $this->RenderText('Institute Id'), $this->RenderText('CropID'), $this->RenderText('Where Researched'), $this->RenderText('Info Id')),
                array(
