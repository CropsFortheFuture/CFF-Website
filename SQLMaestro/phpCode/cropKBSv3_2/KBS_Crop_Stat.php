 ...
 */
    ...
    class KBS_Crop_StatPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Crop_Stat`');
            $field = new IntegerField('statID', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('cropID');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_cultivated_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_cultivated_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_cultivated_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_cultivated_unit');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_harvst_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_harvst_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_harvst_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('area_harvst_unit');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('yield_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('yield_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('yield_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('yield_unit');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_stat_others');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('info_id');
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('statID', 'KBS_General', new IntegerField('cropID', null, null, true), new StringField('name_var_lndrce', 'statID_name_var_lndrce', 'statID_name_var_lndrce_KBS_General'), 'statID_name_var_lndrce_KBS_General');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Statssearch', $this->dataset,
                array('statID_name_var_lndrce', 'cropID', 'area_cultivated_max', 'area_cultivated_mean', 'area_cultivated_min', 'area_cultivated_unit', 'area_harvst_max', 'area_harvst_mean', 'area_harvst_min', 'area_harvst_unit', 'yield_max', 'yield_mean', 'yield_min', 'yield_unit', 'kbs_stat_others', 'info_id'),
                array($this->RenderText('StatID'), $this->RenderText('CropID'), $this->RenderText('Area Cultivated Max'), $this->RenderText('Area Cultivated Mean'), $this->RenderText('Area Cultivated Min'), $this->RenderText('Area Cultivated Unit'), $this->RenderText('Area Harvst Max'), $this->RenderText('Area Harvst Mean'), $this->RenderText('Area Harvst Min'), $this->RenderText('Area Harvst Unit'), $this->RenderText('Yield Max'), $this->RenderText('Yield Mean'), $this->RenderText('Yield Min'), $this->RenderText('Yield Unit'), $this->RenderText('Kbs Stat Others'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Crop_Statasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('statID', $this->RenderText('StatID'), $lookupDataset, 'cropID', 'name_var_lndrce', false, 8));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_cultivated_max', $this->RenderText('Area Cultivated Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_cultivated_mean', $this->RenderText('Area Cultivated Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_cultivated_min', $this->RenderText('Area Cultivated Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_cultivated_unit', $this->RenderText('Area Cultivated Unit')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_harvst_max', $this->RenderText('Area Harvst Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_harvst_mean', $this->RenderText('Area Harvst Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_harvst_min', $this->RenderText('Area Harvst Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('area_harvst_unit', $this->RenderText('Area Harvst Unit')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('yield_max', $this->RenderText('Yield Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('yield_mean', $this->RenderText('Yield Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('yield_min', $this->RenderText('Yield Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('yield_unit', $this->RenderText('Yield Unit')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_stat_others', $this->RenderText('Kbs Stat Others')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('statID_name_var_lndrce', 'StatID', $this->dataset);
            ...
            //
            // View column for area_cultivated_max field
            //
            $column = new TextViewColumn('area_cultivated_max', 'Area Cultivated Max', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for area_cultivated_mean field
            //
            $column = new TextViewColumn('area_cultivated_mean', 'Area Cultivated Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for area_cultivated_min field
            //
            $column = new TextViewColumn('area_cultivated_min', 'Area Cultivated Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for area_cultivated_unit field
            //
            $column = new TextViewColumn('area_cultivated_unit', 'Area Cultivated Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for area_harvst_max field
            //
            $column = new TextViewColumn('area_harvst_max', 'Area Harvst Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for area_harvst_mean field
            //
            $column = new TextViewColumn('area_harvst_mean', 'Area Harvst Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for area_harvst_min field
            //
            $column = new TextViewColumn('area_harvst_min', 'Area Harvst Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for area_harvst_unit field
            //
            $column = new TextViewColumn('area_harvst_unit', 'Area Harvst Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for yield_max field
            //
            $column = new TextViewColumn('yield_max', 'Yield Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for yield_mean field
            //
            $column = new TextViewColumn('yield_mean', 'Yield Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for yield_min field
            //
            $column = new TextViewColumn('yield_min', 'Yield Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for yield_unit field
            //
            $column = new TextViewColumn('yield_unit', 'Yield Unit', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_stat_others field
            //
            $column = new TextViewColumn('kbs_stat_others', 'Kbs Stat Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_StatGrid_kbs_stat_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_StatGrid_kbs_stat_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for area_cultivated_max field
            //
            $editor = new TextEdit('area_cultivated_max_edit');
            $editColumn = new CustomEditColumn('Area Cultivated Max', 'area_cultivated_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_cultivated_mean field
            //
            $editor = new TextEdit('area_cultivated_mean_edit');
            $editColumn = new CustomEditColumn('Area Cultivated Mean', 'area_cultivated_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_cultivated_min field
            //
            $editor = new TextEdit('area_cultivated_min_edit');
            $editColumn = new CustomEditColumn('Area Cultivated Min', 'area_cultivated_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_cultivated_unit field
            //
            $editor = new TextEdit('area_cultivated_unit_edit');
            $editColumn = new CustomEditColumn('Area Cultivated Unit', 'area_cultivated_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_harvst_max field
            //
            $editor = new TextEdit('area_harvst_max_edit');
            $editColumn = new CustomEditColumn('Area Harvst Max', 'area_harvst_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_harvst_mean field
            //
            $editor = new TextEdit('area_harvst_mean_edit');
            $editColumn = new CustomEditColumn('Area Harvst Mean', 'area_harvst_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_harvst_min field
            //
            $editor = new TextEdit('area_harvst_min_edit');
            $editColumn = new CustomEditColumn('Area Harvst Min', 'area_harvst_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for area_harvst_unit field
            //
            $editor = new TextEdit('area_harvst_unit_edit');
            $editColumn = new CustomEditColumn('Area Harvst Unit', 'area_harvst_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for yield_max field
            //
            $editor = new TextEdit('yield_max_edit');
            $editColumn = new CustomEditColumn('Yield Max', 'yield_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for yield_mean field
            //
            $editor = new TextEdit('yield_mean_edit');
            $editColumn = new CustomEditColumn('Yield Mean', 'yield_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for yield_min field
            //
            $editor = new TextEdit('yield_min_edit');
            $editColumn = new CustomEditColumn('Yield Min', 'yield_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for yield_unit field
            //
            $editor = new TextEdit('yield_unit_edit');
            $editColumn = new CustomEditColumn('Yield Unit', 'yield_unit', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_stat_others field
            //
            $editor = new TextEdit('kbs_stat_others_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Kbs Stat Others', 'kbs_stat_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Crop_Stat_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Crop_StatGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_stat_others', 'Kbs Stat Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_StatGrid_kbs_stat_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_stat_others field
            //
            $column = new TextViewColumn('kbs_stat_others', 'Kbs Stat Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_StatGrid_kbs_stat_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Crop_StatPage("KBS_Crop_Stat.php", "KBS_Crop_Stat", GetCurrentUserGrantForDataSource("KBS_Crop_Stat"), 'UTF-8');
        $Page->SetShortCaption('KBS Crop Stat');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Crop Stat');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Crop_Stat"));
