    ...
    class KBS_Crop_SynonymsPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Synonymsssearch', $this->dataset,
                array('synonym_id', 'sci_name_syn', 'cropID_name_var_lndrce', 'info_id'),
                array($this->RenderText('Synonym Id'), $this->RenderText('Sci Name Syn'), $this->RenderText('CropID'), $this->RenderText('Info Id')),
                array(
