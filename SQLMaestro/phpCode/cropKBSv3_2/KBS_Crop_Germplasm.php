    ...
    class KBS_Crop_GermplasmPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Crop_Germplasm`');
            $field = new IntegerField('germplasm_id');
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('institute_id', $this->RenderText('Institute Id')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for institute_id field
            //
            $column = new TextViewColumn('institute_id', 'Institute Id', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('institute_id_edit');
            $editColumn = new CustomEditColumn('Institute Id', 'institute_id', $editor, $this->dataset);
