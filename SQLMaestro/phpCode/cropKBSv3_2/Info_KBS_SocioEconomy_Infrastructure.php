 ...
 */
    ...
    class Info_KBS_SocioEconomy_InfrastructurePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`Info_KBS_SocioEconomy_Infrastructure`');
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_infrastruct_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_SocioEconomy_Infrastructuressearch', $this->dataset,
                array('cropID', 'location_ID', 'infrastructure_power_mains', 'infrastructure_power_genset', 'infrastructure_power_animals', 'infrastructure_power_auto', 'infrastructure_home_use_crop', 'infrastructure_locmarket_crop', 'infrastructure_loctrade_crop', 'infrastructure_processor_crop', 'infrastructure_nonlocaltrader_crop', 'infrastructure_wholesaler_crop', 'infrastructure_supermarkets_crop', 'kbs_infrastruct_others'),
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_SocioEconomy_Infrastructureasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_infrastruct_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_SocioEconomy_Infrastructure_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_SocioEconomy_InfrastructureGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_SocioEconomy_InfrastructurePage("Info_KBS_SocioEconomy_Infrastructure.php", "Info_KBS_SocioEconomy_Infrastructure", GetCurrentUserGrantForDataSource("Info_KBS_SocioEconomy_Infrastructure"), 'UTF-8');
        $Page->SetShortCaption('Info KBS SocioEconomy Infrastructure');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS SocioEconomy Infrastructure');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_SocioEconomy_Infrastructure"));
