 ...
 */
    ...
    class Info_KBS_Agro_FertiliserPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('organ_Fertiliser_type');
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_fert_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Fertiliserasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('organ_fertiliser_type_edit');
            ...
            //
            $editor = new TextEdit('kbs_fert_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Fertiliser_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_FertiliserGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_FertiliserPage("Info_KBS_Agro_Fertiliser.php", "Info_KBS_Agro_Fertiliser", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Fertiliser"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Fertiliser');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Fertiliser');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Fertiliser"));
