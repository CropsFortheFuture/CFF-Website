 ...
 */
    ...
    class KBS_localname_trialPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_localname_trial`');
            $field = new IntegerField('localname_id', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('cropID');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('localname');
            $this->dataset->AddField($field, false);
            $field = new StringField('localname_countryname');
            $this->dataset->AddField($field, false);
            $field = new StringField('localname_ref');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('country_id');
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('localname_id', 'KBS_General', new IntegerField('cropID', null, null, true), new StringField('name_var_lndrce', 'localname_id_name_var_lndrce', 'localname_id_name_var_lndrce_KBS_General'), 'localname_id_name_var_lndrce_KBS_General');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_localname_trialssearch', $this->dataset,
                array('localname_id_name_var_lndrce', 'cropID', 'localname', 'localname_countryname', 'localname_ref', 'country_id'),
                array($this->RenderText('Localname Id'), $this->RenderText('CropID'), $this->RenderText('Localname'), $this->RenderText('Localname Countryname'), $this->RenderText('Localname Ref'), $this->RenderText('Country Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_localname_trialasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('localname_id', $this->RenderText('Localname Id'), $lookupDataset, 'cropID', 'name_var_lndrce', false, 8));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('localname', $this->RenderText('Localname')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('localname_countryname', $this->RenderText('Localname Countryname')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('localname_ref', $this->RenderText('Localname Ref')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('country_id', $this->RenderText('Country Id')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('localname_id_name_var_lndrce', 'Localname Id', $this->dataset);
            ...
            //
            $column = new TextViewColumn('localname', 'Localname', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for localname_countryname field
            //
            $column = new TextViewColumn('localname_countryname', 'Localname Countryname', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_countryname_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for localname_ref field
            //
            $column = new TextViewColumn('localname_ref', 'Localname Ref', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_ref_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for country_id field
            //
            $column = new TextViewColumn('country_id', 'Country Id', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_countryname_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_localname_trialGrid_localname_ref_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('localname_edit', 50, 8);
            ...
            //
            // Edit column for localname_countryname field
            //
            $editor = new TextAreaEdit('localname_countryname_edit', 50, 8);
            $editColumn = new CustomEditColumn('Localname Countryname', 'localname_countryname', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for localname_ref field
            //
            $editor = new TextAreaEdit('localname_ref_edit', 50, 8);
            $editColumn = new CustomEditColumn('Localname Ref', 'localname_ref', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for country_id field
            //
            $editor = new TextEdit('country_id_edit');
            $editColumn = new CustomEditColumn('Country Id', 'country_id', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_localname_trial_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_localname_trialGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('localname', 'Localname', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_handler_list', $column);
            ...
            $column = new TextViewColumn('localname_countryname', 'Localname Countryname', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_countryname_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for localname_ref field
            //
            $column = new TextViewColumn('localname_ref', 'Localname Ref', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_ref_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for localname field
            //
            $column = new TextViewColumn('localname', 'Localname', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for localname_countryname field
            //
            $column = new TextViewColumn('localname_countryname', 'Localname Countryname', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_countryname_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for localname_ref field
            //
            $column = new TextViewColumn('localname_ref', 'Localname Ref', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_localname_trialGrid_localname_ref_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_localname_trialPage("KBS_localname_trial.php", "KBS_localname_trial", GetCurrentUserGrantForDataSource("KBS_localname_trial"), 'UTF-8');
        $Page->SetShortCaption('KBS Localname Trial');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Localname Trial');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_localname_trial"));
