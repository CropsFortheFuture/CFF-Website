 ...
 */
    ...
    class KBS_Crop_Vernacular_NamePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Crop_Vernacular_Name`');
            $field = new IntegerField('vernacular_id');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('cropID');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('vernacular_name');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Vernacular_Namessearch', $this->dataset,
                array('vernacular_id', 'cropID_name_var_lndrce', 'vernacular_name', 'info_id'),
                array($this->RenderText('Vernacular Id'), $this->RenderText('CropID'), $this->RenderText('Vernacular Name'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Crop_Vernacular_Nameasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('vernacular_id', $this->RenderText('Vernacular Id')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('vernacular_name', $this->RenderText('Vernacular Name')));
        ...
        {
            //
            // View column for vernacular_id field
            //
            $column = new TextViewColumn('vernacular_id', 'Vernacular Id', $this->dataset);
            ...
            //
            // View column for vernacular_name field
            //
            $column = new TextViewColumn('vernacular_name', 'Vernacular Name', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_Vernacular_NameGrid_vernacular_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_Vernacular_NameGrid_vernacular_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        {
            //
            // Edit column for vernacular_id field
            //
            $editor = new ComboBox('vernacular_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editColumn = new CustomEditColumn('Vernacular Id', 'vernacular_id', $editor, $this->dataset);
            ...
            //
            // Edit column for vernacular_name field
            //
            $editor = new TextEdit('vernacular_name_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Vernacular Name', 'vernacular_name', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Crop_Vernacular_Name_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Crop_Vernacular_NameGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('vernacular_name', 'Vernacular Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_Vernacular_NameGrid_vernacular_name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for vernacular_name field
            //
            $column = new TextViewColumn('vernacular_name', 'Vernacular Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_Vernacular_NameGrid_vernacular_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Crop_Vernacular_NamePage("KBS_Crop_Vernacular_Name.php", "KBS_Crop_Vernacular_Name", GetCurrentUserGrantForDataSource("KBS_Crop_Vernacular_Name"), 'UTF-8');
        $Page->SetShortCaption('KBS Crop Vernacular Name');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Crop Vernacular Name');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Crop_Vernacular_Name"));
