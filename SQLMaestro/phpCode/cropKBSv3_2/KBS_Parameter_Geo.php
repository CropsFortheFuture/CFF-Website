 ...
 */
    ...
    class KBS_Parameter_GeoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Parameter_Geo`');
            $field = new IntegerField('GeoID', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Parameter_Geossearch', $this->dataset,
                array('GeoID', 'cropID_name_var_lndrce', 'country_id', 'info_id'),
                array($this->RenderText('GeoID'), $this->RenderText('CropID'), $this->RenderText('Country Id'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Parameter_Geoasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('GeoID', $this->RenderText('GeoID')));
        ...
        {
            //
            // View column for GeoID field
            //
            $column = new TextViewColumn('GeoID', 'GeoID', $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Parameter_Geo_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Parameter_GeoGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new KBS_Parameter_GeoPage("KBS_Parameter_Geo.php", "KBS_Parameter_Geo", GetCurrentUserGrantForDataSource("KBS_Parameter_Geo"), 'UTF-8');
        $Page->SetShortCaption('KBS Parameter Geo');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Parameter Geo');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Parameter_Geo"));
