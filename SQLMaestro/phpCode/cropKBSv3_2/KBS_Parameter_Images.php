 ...
 */
    ...
    class KBS_Parameter_ImagesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Parameter_Images`');
            $field = new IntegerField('image_id', null, null, true);
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('image_note');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('country_id');
            $this->dataset->AddField($field, false);
            $field = new StringField('reference');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Parameter_Imagesssearch', $this->dataset,
                array('image_id', 'cropID_name_var_lndrce', 'path', 'image_note', 'country_id', 'reference', 'note', 'info_id'),
                array($this->RenderText('Image Id'), $this->RenderText('CropID'), $this->RenderText('Path'), $this->RenderText('Image Note'), $this->RenderText('Country Id'), $this->RenderText('Reference'), $this->RenderText('Note'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Parameter_Imagesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('image_id', $this->RenderText('Image Id')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('image_note', $this->RenderText('Image Note')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('reference', $this->RenderText('Reference')));
        ...
        {
            //
            // View column for image_id field
            //
            $column = new TextViewColumn('image_id', 'Image Id', $this->dataset);
            ...
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_path_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for image_note field
            //
            $column = new TextViewColumn('image_note', 'Image Note', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for reference field
            //
            $column = new TextViewColumn('reference', 'Reference', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_reference_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_note_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_path_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_reference_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Parameter_ImagesGrid_note_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for image_note field
            //
            $editor = new TextEdit('image_note_edit');
            $editColumn = new CustomEditColumn('Image Note', 'image_note', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for reference field
            //
            $editor = new TextAreaEdit('reference_edit', 50, 8);
            $editColumn = new CustomEditColumn('Reference', 'reference', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Parameter_Images_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Parameter_ImagesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('path', 'Path', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_path_handler_list', $column);
            ...
            $column = new TextViewColumn('reference', 'Reference', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_reference_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for note field
            //
            $column = new TextViewColumn('note', 'Note', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_note_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for path field
            //
            $column = new TextViewColumn('path', 'Path', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_path_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for reference field
            //
            $column = new TextViewColumn('reference', 'Reference', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_reference_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for note field
            //
            $column = new TextViewColumn('note', 'Note', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Parameter_ImagesGrid_note_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Parameter_ImagesPage("KBS_Parameter_Images.php", "KBS_Parameter_Images", GetCurrentUserGrantForDataSource("KBS_Parameter_Images"), 'UTF-8');
        $Page->SetShortCaption('KBS Parameter Images');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Parameter Images');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Parameter_Images"));
