    ...
    class KBS_General_Parts_UsedPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Parts_Usedssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'usage_id', 'part_used_bark', 'part_used_bulb', 'part_used_flower', 'part_used_fruits', 'part_used_grain', 'part_used_leaf', 'part_used_petiold', 'part_used_root', 'part_used_seed', 'part_used_stem', 'part_used_tuber', 'part_used_whole', 'part_used_wood', 'kbs_part_used_others'),
