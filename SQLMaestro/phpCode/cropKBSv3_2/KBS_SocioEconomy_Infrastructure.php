    ...
    class KBS_SocioEconomy_InfrastructurePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_SocioEconomy_Infrastructuressearch', $this->dataset,
                array('cropID_name_var_lndrce', 'location_ID', 'infrastructure_power_mains', 'infrastructure_power_genset', 'infrastructure_power_animals', 'infrastructure_power_auto', 'infrastructure_home_use_crop', 'infrastructure_locmarket_crop', 'infrastructure_loctrade_crop', 'infrastructure_processor_crop', 'infrastructure_nonlocaltrader_crop', 'infrastructure_wholesaler_crop', 'infrastructure_supermarkets_crop', 'kbs_infrastruct_others'),
