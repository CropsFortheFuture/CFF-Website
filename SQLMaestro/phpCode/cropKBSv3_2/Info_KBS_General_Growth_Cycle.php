 ...
 */
    ...
    class Info_KBS_General_Growth_CyclePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_cycle_prennial');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('growth_cycle_other');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_gc_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_General_Growth_Cyclessearch', $this->dataset,
                array('cropID', 'growth_cycle_annual', 'growth_cycle_biannual', 'growth_cycle_prennial', 'growth_cycle_other', 'kbs_gc_others'),
                array($this->RenderText('CropID'), $this->RenderText('Growth Cycle Annual'), $this->RenderText('Growth Cycle Biannual'), $this->RenderText('Growth Cycle Prennial'), $this->RenderText('Growth Cycle Other'), $this->RenderText('Kbs Gc Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_General_Growth_Cycleasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('growth_cycle_prennial', $this->RenderText('Growth Cycle Prennial')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for growth_cycle_prennial field
            //
            $column = new TextViewColumn('growth_cycle_prennial', 'Growth Cycle Prennial', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('growth_cycle_annual_edit');
            ...
            //
            $editor = new TextEdit('growth_cycle_biannual_edit');
            ...
            //
            // Edit column for growth_cycle_prennial field
            //
            $editor = new TextEdit('growth_cycle_prennial_edit');
            $editColumn = new CustomEditColumn('Growth Cycle Prennial', 'growth_cycle_prennial', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new TextEdit('growth_cycle_other_edit');
            ...
            //
            $editor = new TextEdit('kbs_gc_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_Growth_Cycle_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_General_Growth_CycleGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_General_Growth_CyclePage("Info_KBS_General_Growth_Cycle.php", "Info_KBS_General_Growth_Cycle", GetCurrentUserGrantForDataSource("Info_KBS_General_Growth_Cycle"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General Growth Cycle');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General Growth Cycle');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General_Growth_Cycle"));
