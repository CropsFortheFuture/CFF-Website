 ...
 */
    ...
    class Info_KBS_General_Growth_HabitPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_gh_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_General_Growth_Habitssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_General_Growth_Habitasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_gh_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_Growth_Habit_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_General_Growth_HabitGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_General_Growth_HabitPage("Info_KBS_General_Growth_Habit.php", "Info_KBS_General_Growth_Habit", GetCurrentUserGrantForDataSource("Info_KBS_General_Growth_Habit"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General Growth Habit');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General Growth Habit');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General_Growth_Habit"));
