    ...
    class KBS_General_TypePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Typessearch', $this->dataset,
                array('cropID_name_var_lndrce', 'type_cereals', 'type_forest_tree', 'type_fruit', 'type_grass', 'type_herb', 'type_legume', 'type_nut', 'type_pseudocereal', 'type_pulse', 'type_root', 'type_tuber', 'type_vegetable', 'kbs_type_others'),
