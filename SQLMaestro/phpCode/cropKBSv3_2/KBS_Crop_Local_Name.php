    ...
    class KBS_Crop_Local_NamePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Local_Namessearch', $this->dataset,
                array('localname_id', 'cropID_name_var_lndrce', 'localname', 'info_id'),
                array($this->RenderText('Localname Id'), $this->RenderText('CropID'), $this->RenderText('Localname'), $this->RenderText('Info Id')),
                array(
