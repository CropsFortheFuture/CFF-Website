 ...
 */
    ...
    class Info_KBS_General_UsagePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_gen_usg_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_General_Usagessearch', $this->dataset,
                array('cropID', 'gen_use_aroma', 'gen_use_bever', 'gen_use_bioma', 'gen_use_const', 'gen_use_food', 'gen_use_forag', 'gen_use_herb', 'gen_use_indus', 'gen_use_medic', 'gen_use_ornam', 'gen_use_relig', 'gen_use_stimu', 'gen_use_apiculture', 'kbs_gen_usg_others'),
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_General_Usageasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('gen_use_aroma_edit');
            ...
            //
            $editor = new TextEdit('gen_use_bever_edit');
            ...
            //
            $editor = new TextEdit('gen_use_bioma_edit');
            ...
            //
            $editor = new TextEdit('gen_use_const_edit');
            ...
            //
            $editor = new TextEdit('gen_use_food_edit');
            ...
            //
            $editor = new TextEdit('gen_use_forag_edit');
            ...
            //
            $editor = new TextEdit('gen_use_herb_edit');
            ...
            //
            $editor = new TextEdit('gen_use_indus_edit');
            ...
            //
            $editor = new TextEdit('gen_use_medic_edit');
            ...
            //
            $editor = new TextEdit('gen_use_ornam_edit');
            ...
            //
            $editor = new TextEdit('gen_use_relig_edit');
            ...
            //
            $editor = new TextEdit('gen_use_stimu_edit');
            ...
            //
            $editor = new TextEdit('gen_use_apiculture_edit');
            ...
            //
            $editor = new TextEdit('kbs_gen_usg_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_Usage_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_General_UsageGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_General_UsagePage("Info_KBS_General_Usage.php", "Info_KBS_General_Usage", GetCurrentUserGrantForDataSource("Info_KBS_General_Usage"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General Usage');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General Usage');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General_Usage"));
