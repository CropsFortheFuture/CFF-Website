    ...
    class KBS_Crop_CRO_FilePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_CRO_Filessearch', $this->dataset,
                array('CRO_id', 'cropID_name_var_lndrce', 'CRO_path', 'info_id'),
                array($this->RenderText('CRO Id'), $this->RenderText('CropID'), $this->RenderText('CRO Path'), $this->RenderText('Info Id')),
                array(
