 ...
 */
    ...
    class Info_KBS_GeneralPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('name_var_lndrce');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('name');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('sci_name');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('fam_name');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('genus_name');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('variety');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('landrace');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('plant');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_gen_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Generalssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Generalasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_gen_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_GeneralGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_GeneralPage("Info_KBS_General.php", "Info_KBS_General", GetCurrentUserGrantForDataSource("Info_KBS_General"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General"));
