 ...
 */
    ...
    class Info_KBS_SocioEconomy_MarketPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_market_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_SocioEconomy_Marketssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_SocioEconomy_Marketasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_market_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_SocioEconomy_Market_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_SocioEconomy_MarketGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_SocioEconomy_MarketPage("Info_KBS_SocioEconomy_Market.php", "Info_KBS_SocioEconomy_Market", GetCurrentUserGrantForDataSource("Info_KBS_SocioEconomy_Market"), 'UTF-8');
        $Page->SetShortCaption('Info KBS SocioEconomy Market');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS SocioEconomy Market');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_SocioEconomy_Market"));
