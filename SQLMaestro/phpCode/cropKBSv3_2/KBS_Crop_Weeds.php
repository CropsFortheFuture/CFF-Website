 ...
 */
    ...
    class KBS_Crop_WeedsPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Weedsssearch', $this->dataset,
                array('weed_id', 'cropID_name_var_lndrce', 'info_id'),
                array($this->RenderText('Weed Id'), $this->RenderText('CropID'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Crop_Weedsasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('weed_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Crop_Weeds_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Crop_WeedsGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new KBS_Crop_WeedsPage("KBS_Crop_Weeds.php", "KBS_Crop_Weeds", GetCurrentUserGrantForDataSource("KBS_Crop_Weeds"), 'UTF-8');
        $Page->SetShortCaption('KBS Crop Weeds');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Crop Weeds');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Crop_Weeds"));
