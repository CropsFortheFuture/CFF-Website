 ...
 */
    ...
    class KBS_Agro_SeasonPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('season_1_year');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_2_year');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_3_year');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_all_year');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_semi_permanent');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_irrigated');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_irrig_rainfed');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_length_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_length_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_length_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('season_rainfed');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_season_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Agro_Seasonssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'season_1_year', 'season_2_year', 'season_3_year', 'season_all_year', 'season_semi_permanent', 'season_irrigated', 'season_irrig_rainfed', 'season_length_min', 'season_length_max', 'season_length_mean', 'season_rainfed', 'kbs_season_others'),
                array($this->RenderText('CropID'), $this->RenderText('Season 1 Year'), $this->RenderText('Season 2 Year'), $this->RenderText('Season 3 Year'), $this->RenderText('Season All Year'), $this->RenderText('Season Semi Permanent'), $this->RenderText('Season Irrigated'), $this->RenderText('Season Irrig Rainfed'), $this->RenderText('Season Length Min'), $this->RenderText('Season Length Max'), $this->RenderText('Season Length Mean'), $this->RenderText('Season Rainfed'), $this->RenderText('Kbs Season Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Agro_Seasonasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_1_year', $this->RenderText('Season 1 Year')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_2_year', $this->RenderText('Season 2 Year')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_3_year', $this->RenderText('Season 3 Year')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_all_year', $this->RenderText('Season All Year')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_semi_permanent', $this->RenderText('Season Semi Permanent')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_irrigated', $this->RenderText('Season Irrigated')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_irrig_rainfed', $this->RenderText('Season Irrig Rainfed')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_length_min', $this->RenderText('Season Length Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_length_max', $this->RenderText('Season Length Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_length_mean', $this->RenderText('Season Length Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('season_rainfed', $this->RenderText('Season Rainfed')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_season_others', $this->RenderText('Kbs Season Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for season_1_year field
            //
            $column = new TextViewColumn('season_1_year', 'Season 1 Year', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_2_year field
            //
            $column = new TextViewColumn('season_2_year', 'Season 2 Year', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_3_year field
            //
            $column = new TextViewColumn('season_3_year', 'Season 3 Year', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_all_year field
            //
            $column = new TextViewColumn('season_all_year', 'Season All Year', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_semi_permanent field
            //
            $column = new TextViewColumn('season_semi_permanent', 'Season Semi Permanent', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_irrigated field
            //
            $column = new TextViewColumn('season_irrigated', 'Season Irrigated', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for season_irrig_rainfed field
            //
            $column = new TextViewColumn('season_irrig_rainfed', 'Season Irrig Rainfed', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new TextViewColumn('season_length_min', 'Season Length Min', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            $column = new TextViewColumn('season_length_max', 'Season Length Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for season_length_mean field
            //
            $column = new TextViewColumn('season_length_mean', 'Season Length Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for season_rainfed field
            //
            $column = new TextViewColumn('season_rainfed', 'Season Rainfed', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_season_others field
            //
            $column = new TextViewColumn('kbs_season_others', 'Kbs Season Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Agro_SeasonGrid_kbs_season_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Agro_SeasonGrid_kbs_season_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for season_1_year field
            //
            $editor = new TextEdit('season_1_year_edit');
            $editColumn = new CustomEditColumn('Season 1 Year', 'season_1_year', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_2_year field
            //
            $editor = new TextEdit('season_2_year_edit');
            $editColumn = new CustomEditColumn('Season 2 Year', 'season_2_year', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_3_year field
            //
            $editor = new TextEdit('season_3_year_edit');
            $editColumn = new CustomEditColumn('Season 3 Year', 'season_3_year', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_all_year field
            //
            $editor = new TextEdit('season_all_year_edit');
            $editColumn = new CustomEditColumn('Season All Year', 'season_all_year', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_semi_permanent field
            //
            $editor = new TextEdit('season_semi_permanent_edit');
            $editColumn = new CustomEditColumn('Season Semi Permanent', 'season_semi_permanent', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_irrigated field
            //
            $editor = new TextEdit('season_irrigated_edit');
            $editColumn = new CustomEditColumn('Season Irrigated', 'season_irrigated', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_irrig_rainfed field
            //
            $editor = new TextEdit('season_irrig_rainfed_edit');
            $editColumn = new CustomEditColumn('Season Irrig Rainfed', 'season_irrig_rainfed', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for season_length_mean field
            //
            $editor = new TextEdit('season_length_mean_edit');
            $editColumn = new CustomEditColumn('Season Length Mean', 'season_length_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for season_rainfed field
            //
            $editor = new TextEdit('season_rainfed_edit');
            $editColumn = new CustomEditColumn('Season Rainfed', 'season_rainfed', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_season_others field
            //
            $editor = new TextAreaEdit('kbs_season_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Season Others', 'kbs_season_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Agro_Season_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Agro_SeasonGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_season_others', 'Kbs Season Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Agro_SeasonGrid_kbs_season_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_season_others field
            //
            $column = new TextViewColumn('kbs_season_others', 'Kbs Season Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Agro_SeasonGrid_kbs_season_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Agro_SeasonPage("KBS_Agro_Season.php", "KBS_Agro_Season", GetCurrentUserGrantForDataSource("KBS_Agro_Season"), 'UTF-8');
        $Page->SetShortCaption('KBS Agro Season');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Agro Season');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Agro_Season"));
