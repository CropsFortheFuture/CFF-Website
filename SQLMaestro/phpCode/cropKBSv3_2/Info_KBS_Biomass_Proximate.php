 ...
 */
    ...
    class Info_KBS_Biomass_ProximatePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_biompart_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Biomass_Proximatessearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Biomass_Proximateasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_biompart_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Biomass_Proximate_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Biomass_ProximateGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Biomass_ProximatePage("Info_KBS_Biomass_Proximate.php", "Info_KBS_Biomass_Proximate", GetCurrentUserGrantForDataSource("Info_KBS_Biomass_Proximate"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Biomass Proximate');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Biomass Proximate');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Biomass_Proximate"));
