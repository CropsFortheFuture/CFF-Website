 ...
 */
    ...
    class Info_KBS_General_TypePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_type_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_General_Typessearch', $this->dataset,
                array('cropID', 'type_cereals', 'type_forest_tree', 'type_fruit', 'type_grass', 'type_herb', 'type_legume', 'type_nut', 'type_pseudocereal', 'type_pulse', 'type_root', 'type_tuber', 'type_vegetable', 'kbs_type_others'),
                array($this->RenderText('CropID'), $this->RenderText('Type Cereals'), $this->RenderText('Type Forest Tree'), $this->RenderText('Type Fruit'), $this->RenderText('Type Grass'), $this->RenderText('Type Herb'), $this->RenderText('Type Legume'), $this->RenderText('Type Nut'), $this->RenderText('Type Pseudocereal'), $this->RenderText('Type Pulse'), $this->RenderText('Type Root'), $this->RenderText('Type Tuber'), $this->RenderText('Type Vegetable'), $this->RenderText('Kbs Type Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_General_Typeasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('type_cereals_edit');
            ...
            //
            $editor = new TextEdit('type_forest_tree_edit');
            ...
            //
            $editor = new TextEdit('type_fruit_edit');
            ...
            //
            $editor = new TextEdit('type_grass_edit');
            ...
            //
            $editor = new TextEdit('type_herb_edit');
            ...
            //
            $editor = new TextEdit('type_legume_edit');
            ...
            //
            $editor = new TextEdit('type_nut_edit');
            ...
            //
            $editor = new TextEdit('type_pseudocereal_edit');
            ...
            //
            $editor = new TextEdit('type_pulse_edit');
            ...
            //
            $editor = new TextEdit('type_root_edit');
            ...
            //
            $editor = new TextEdit('type_tuber_edit');
            ...
            //
            $editor = new TextEdit('type_vegetable_edit');
            ...
            //
            $editor = new TextEdit('kbs_type_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_Type_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_General_TypeGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_General_TypePage("Info_KBS_General_Type.php", "Info_KBS_General_Type", GetCurrentUserGrantForDataSource("Info_KBS_General_Type"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General Type');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General Type');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General_Type"));
