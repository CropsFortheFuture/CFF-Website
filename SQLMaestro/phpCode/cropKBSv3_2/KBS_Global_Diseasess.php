 ...
 */
    ...
    class KBS_Global_DiseasessPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Global_Diseasess`');
            $field = new IntegerField('disease_id');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('disease_sci_name');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Global_Diseasessssearch', $this->dataset,
                array('disease_id', 'disease_sci_name', 'disease_name', 'info_id'),
                array($this->RenderText('Disease Id'), $this->RenderText('Disease Sci Name'), $this->RenderText('Disease Name'), $this->RenderText('Info Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Global_Diseasessasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('disease_id', $this->RenderText('Disease Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('disease_sci_name', $this->RenderText('Disease Sci Name')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('disease_name', $this->RenderText('Disease Name')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('disease_id', 'Disease Id', $this->dataset);
            ...
            //
            // View column for disease_sci_name field
            //
            $column = new TextViewColumn('disease_sci_name', 'Disease Sci Name', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasessGrid_disease_sci_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new TextViewColumn('disease_name', 'Disease Name', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasessGrid_disease_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasessGrid_disease_sci_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Global_DiseasessGrid_disease_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for disease_sci_name field
            //
            $editor = new TextEdit('disease_sci_name_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Disease Sci Name', 'disease_sci_name', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Global_Diseasess_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Global_DiseasessGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('disease_sci_name', 'Disease Sci Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasessGrid_disease_sci_name_handler_list', $column);
            ...
            $column = new TextViewColumn('disease_name', 'Disease Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasessGrid_disease_name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for disease_sci_name field
            //
            $column = new TextViewColumn('disease_sci_name', 'Disease Sci Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasessGrid_disease_sci_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for disease_name field
            //
            $column = new TextViewColumn('disease_name', 'Disease Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Global_DiseasessGrid_disease_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Global_DiseasessPage("KBS_Global_Diseasess.php", "KBS_Global_Diseasess", GetCurrentUserGrantForDataSource("KBS_Global_Diseasess"), 'UTF-8');
        $Page->SetShortCaption('KBS Global Diseasess');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Global Diseasess');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Global_Diseasess"));
