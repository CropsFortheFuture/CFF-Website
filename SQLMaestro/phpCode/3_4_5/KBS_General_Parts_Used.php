 ...
 */
    ...
    class KBS_General_Parts_UsedPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('usage_id', 'KBS_Global_Parts_ID', new IntegerField('part_id', null, null, true), new StringField('part_name', 'usage_id_part_name', 'usage_id_part_name_KBS_Global_Parts_ID'), 'usage_id_part_name_KBS_Global_Parts_ID');
        }
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Parts_Usedssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'usage_id_part_name', 'part_used_bark', 'part_used_bulb', 'part_used_flower', 'part_used_fruits', 'part_used_grain', 'part_used_leaf', 'part_used_petiole', 'part_used_root', 'part_used_seed', 'part_used_stem', 'part_used_tuber', 'part_used_whole', 'part_used_wood', 'kbs_part_used_others', 'id'),
                array($this->RenderText('CropID'), $this->RenderText('Usage Id'), $this->RenderText('Part Used Bark'), $this->RenderText('Part Used Bulb'), $this->RenderText('Part Used Flower'), $this->RenderText('Part Used Fruits'), $this->RenderText('Part Used Grain'), $this->RenderText('Part Used Leaf'), $this->RenderText('Part Used Petiole'), $this->RenderText('Part Used Root'), $this->RenderText('Part Used Seed'), $this->RenderText('Part Used Stem'), $this->RenderText('Part Used Tuber'), $this->RenderText('Part Used Whole'), $this->RenderText('Part Used Wood'), $this->RenderText('Kbs Part Used Others'), $this->RenderText('Id')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $lookupDataset = new TableDataset(
                ...
                GetConnectionOptions(),
                '`KBS_Global_Parts_ID`');
            $field = new IntegerField('part_id', null, null, true);
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, true);
            $field = new StringField('part_name');
            $lookupDataset->AddField($field, false);
            $lookupDataset->setOrderByField('part_name', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('usage_id', $this->RenderText('Usage Id'), $lookupDataset, 'part_id', 'part_name', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('usage_id_part_name', 'Usage Id', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('usage_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Parts_ID`');
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'usage_id', 
                $editor, 
                $this->dataset, 'part_id', 'part_name', $lookupDataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new CheckBox('part_used_bark_edit');
            ...
            //
            $editor = new CheckBox('part_used_bulb_edit');
            ...
            //
            $editor = new CheckBox('part_used_flower_edit');
            ...
            //
            $editor = new CheckBox('part_used_fruits_edit');
            ...
            //
            $editor = new CheckBox('part_used_grain_edit');
            ...
            //
            $editor = new CheckBox('part_used_leaf_edit');
            ...
            //
            $editor = new CheckBox('part_used_petiole_edit');
            ...
            //
            $editor = new CheckBox('part_used_root_edit');
            ...
            //
            $editor = new CheckBox('part_used_seed_edit');
            ...
            //
            $editor = new CheckBox('part_used_stem_edit');
            ...
            //
            $editor = new CheckBox('part_used_tuber_edit');
            ...
            //
            $editor = new CheckBox('part_used_whole_edit');
            ...
            //
            $editor = new CheckBox('part_used_wood_edit');
