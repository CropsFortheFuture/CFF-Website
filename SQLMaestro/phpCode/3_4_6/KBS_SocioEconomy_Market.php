 ...
 */
    ...
    class KBS_SocioEconomy_MarketPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('market_seedsorce_formalcertpublic');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('market_seedsorce_formalcertprivate');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('market_seedsorce_formaluncertprivate');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('market_seedsorce_informalprivate');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('market_seedsorce_informalexchange');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('market_seedsorce_ownretained');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_market_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_SocioEconomy_Marketssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'location_ID_google_address', 'market_seedsorce_formalcertpublic', 'market_seedsorce_formalcertprivate', 'market_seedsorce_formaluncertprivate', 'market_seedsorce_informalprivate', 'market_seedsorce_informalexchange', 'market_seedsorce_ownretained', 'kbs_market_others'),
                array($this->RenderText('CropID'), $this->RenderText('Location ID'), $this->RenderText('Market Seedsorce Formalcertpublic'), $this->RenderText('Market Seedsorce Formalcertprivate'), $this->RenderText('Market Seedsorce Formaluncertprivate'), $this->RenderText('Market Seedsorce Informalprivate'), $this->RenderText('Market Seedsorce Informalexchange'), $this->RenderText('Market Seedsorce Ownretained'), $this->RenderText('Kbs Market Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_SocioEconomy_Marketasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_formalcertpublic', $this->RenderText('Market Seedsorce Formalcertpublic')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_formalcertprivate', $this->RenderText('Market Seedsorce Formalcertprivate')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_formaluncertprivate', $this->RenderText('Market Seedsorce Formaluncertprivate')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_informalprivate', $this->RenderText('Market Seedsorce Informalprivate')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_informalexchange', $this->RenderText('Market Seedsorce Informalexchange')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('market_seedsorce_ownretained', $this->RenderText('Market Seedsorce Ownretained')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_market_others', $this->RenderText('Kbs Market Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for market_seedsorce_formalcertpublic field
            //
            $column = new TextViewColumn('market_seedsorce_formalcertpublic', 'Market Seedsorce Formalcertpublic', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for market_seedsorce_formalcertprivate field
            //
            $column = new TextViewColumn('market_seedsorce_formalcertprivate', 'Market Seedsorce Formalcertprivate', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for market_seedsorce_formaluncertprivate field
            //
            $column = new TextViewColumn('market_seedsorce_formaluncertprivate', 'Market Seedsorce Formaluncertprivate', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for market_seedsorce_informalprivate field
            //
            $column = new TextViewColumn('market_seedsorce_informalprivate', 'Market Seedsorce Informalprivate', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for market_seedsorce_informalexchange field
            //
            $column = new TextViewColumn('market_seedsorce_informalexchange', 'Market Seedsorce Informalexchange', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for market_seedsorce_ownretained field
            //
            $column = new TextViewColumn('market_seedsorce_ownretained', 'Market Seedsorce Ownretained', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_market_others field
            //
            $column = new TextViewColumn('kbs_market_others', 'Kbs Market Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_SocioEconomy_MarketGrid_kbs_market_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_SocioEconomy_MarketGrid_kbs_market_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for market_seedsorce_formalcertpublic field
            //
            $editor = new TextEdit('market_seedsorce_formalcertpublic_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Formalcertpublic', 'market_seedsorce_formalcertpublic', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for market_seedsorce_formalcertprivate field
            //
            $editor = new TextEdit('market_seedsorce_formalcertprivate_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Formalcertprivate', 'market_seedsorce_formalcertprivate', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for market_seedsorce_formaluncertprivate field
            //
            $editor = new TextEdit('market_seedsorce_formaluncertprivate_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Formaluncertprivate', 'market_seedsorce_formaluncertprivate', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for market_seedsorce_informalprivate field
            //
            $editor = new TextEdit('market_seedsorce_informalprivate_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Informalprivate', 'market_seedsorce_informalprivate', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for market_seedsorce_informalexchange field
            //
            $editor = new TextEdit('market_seedsorce_informalexchange_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Informalexchange', 'market_seedsorce_informalexchange', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for market_seedsorce_ownretained field
            //
            $editor = new TextEdit('market_seedsorce_ownretained_edit');
            $editColumn = new CustomEditColumn('Market Seedsorce Ownretained', 'market_seedsorce_ownretained', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_market_others field
            //
            $editor = new TextAreaEdit('kbs_market_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Market Others', 'kbs_market_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_SocioEconomy_Market_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_SocioEconomy_MarketGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_market_others', 'Kbs Market Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_SocioEconomy_MarketGrid_kbs_market_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_market_others field
            //
            $column = new TextViewColumn('kbs_market_others', 'Kbs Market Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_SocioEconomy_MarketGrid_kbs_market_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_SocioEconomy_MarketPage("KBS_SocioEconomy_Market.php", "KBS_SocioEconomy_Market", GetCurrentUserGrantForDataSource("KBS_SocioEconomy_Market"), 'UTF-8');
        $Page->SetShortCaption('KBS SocioEconomy Market');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS SocioEconomy Market');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_SocioEconomy_Market"));
