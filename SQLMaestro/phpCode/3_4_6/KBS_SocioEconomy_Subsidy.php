 ...
 */
    ...
    class KBS_SocioEconomy_SubsidyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('subsdy_public_support');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_drct_pymnt_prod');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_fertiliser');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_seed');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_extension_advice');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_equipmnts_tools');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_marketing_help');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('subsdy_pkg_prcss_help');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_subsid_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_SocioEconomy_Subsidyssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'location_ID_google_address', 'subsdy_public_support', 'subsdy_drct_pymnt_prod', 'subsdy_fertiliser', 'subsdy_seed', 'subsdy_extension_advice', 'subsdy_equipmnts_tools', 'subsdy_marketing_help', 'subsdy_pkg_prcss_help', 'kbs_subsid_others'),
                array($this->RenderText('CropID'), $this->RenderText('Location ID'), $this->RenderText('Subsdy Public Support'), $this->RenderText('Subsdy Drct Pymnt Prod'), $this->RenderText('Subsdy Fertiliser'), $this->RenderText('Subsdy Seed'), $this->RenderText('Subsdy Extension Advice'), $this->RenderText('Subsdy Equipmnts Tools'), $this->RenderText('Subsdy Marketing Help'), $this->RenderText('Subsdy Pkg Prcss Help'), $this->RenderText('Kbs Subsid Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_SocioEconomy_Subsidyasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_public_support', $this->RenderText('Subsdy Public Support')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_drct_pymnt_prod', $this->RenderText('Subsdy Drct Pymnt Prod')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_fertiliser', $this->RenderText('Subsdy Fertiliser')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_seed', $this->RenderText('Subsdy Seed')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_extension_advice', $this->RenderText('Subsdy Extension Advice')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_equipmnts_tools', $this->RenderText('Subsdy Equipmnts Tools')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_marketing_help', $this->RenderText('Subsdy Marketing Help')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('subsdy_pkg_prcss_help', $this->RenderText('Subsdy Pkg Prcss Help')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_subsid_others', $this->RenderText('Kbs Subsid Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for subsdy_public_support field
            //
            $column = new TextViewColumn('subsdy_public_support', 'Subsdy Public Support', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_drct_pymnt_prod field
            //
            $column = new TextViewColumn('subsdy_drct_pymnt_prod', 'Subsdy Drct Pymnt Prod', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_fertiliser field
            //
            $column = new TextViewColumn('subsdy_fertiliser', 'Subsdy Fertiliser', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_seed field
            //
            $column = new TextViewColumn('subsdy_seed', 'Subsdy Seed', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_extension_advice field
            //
            $column = new TextViewColumn('subsdy_extension_advice', 'Subsdy Extension Advice', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_equipmnts_tools field
            //
            $column = new TextViewColumn('subsdy_equipmnts_tools', 'Subsdy Equipmnts Tools', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_marketing_help field
            //
            $column = new TextViewColumn('subsdy_marketing_help', 'Subsdy Marketing Help', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for subsdy_pkg_prcss_help field
            //
            $column = new TextViewColumn('subsdy_pkg_prcss_help', 'Subsdy Pkg Prcss Help', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for kbs_subsid_others field
            //
            $column = new TextViewColumn('kbs_subsid_others', 'Kbs Subsid Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_SocioEconomy_SubsidyGrid_kbs_subsid_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_SocioEconomy_SubsidyGrid_kbs_subsid_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for subsdy_public_support field
            //
            $editor = new TextEdit('subsdy_public_support_edit');
            $editColumn = new CustomEditColumn('Subsdy Public Support', 'subsdy_public_support', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_drct_pymnt_prod field
            //
            $editor = new TextEdit('subsdy_drct_pymnt_prod_edit');
            $editColumn = new CustomEditColumn('Subsdy Drct Pymnt Prod', 'subsdy_drct_pymnt_prod', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_fertiliser field
            //
            $editor = new TextEdit('subsdy_fertiliser_edit');
            $editColumn = new CustomEditColumn('Subsdy Fertiliser', 'subsdy_fertiliser', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_seed field
            //
            $editor = new TextEdit('subsdy_seed_edit');
            $editColumn = new CustomEditColumn('Subsdy Seed', 'subsdy_seed', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_extension_advice field
            //
            $editor = new TextEdit('subsdy_extension_advice_edit');
            $editColumn = new CustomEditColumn('Subsdy Extension Advice', 'subsdy_extension_advice', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_equipmnts_tools field
            //
            $editor = new TextEdit('subsdy_equipmnts_tools_edit');
            $editColumn = new CustomEditColumn('Subsdy Equipmnts Tools', 'subsdy_equipmnts_tools', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_marketing_help field
            //
            $editor = new TextEdit('subsdy_marketing_help_edit');
            $editColumn = new CustomEditColumn('Subsdy Marketing Help', 'subsdy_marketing_help', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for subsdy_pkg_prcss_help field
            //
            $editor = new TextEdit('subsdy_pkg_prcss_help_edit');
            $editColumn = new CustomEditColumn('Subsdy Pkg Prcss Help', 'subsdy_pkg_prcss_help', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_subsid_others field
            //
            $editor = new TextAreaEdit('kbs_subsid_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Subsid Others', 'kbs_subsid_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_SocioEconomy_Subsidy_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_SocioEconomy_SubsidyGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_subsid_others', 'Kbs Subsid Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_SocioEconomy_SubsidyGrid_kbs_subsid_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_subsid_others field
            //
            $column = new TextViewColumn('kbs_subsid_others', 'Kbs Subsid Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_SocioEconomy_SubsidyGrid_kbs_subsid_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_SocioEconomy_SubsidyPage("KBS_SocioEconomy_Subsidy.php", "KBS_SocioEconomy_Subsidy", GetCurrentUserGrantForDataSource("KBS_SocioEconomy_Subsidy"), 'UTF-8');
        $Page->SetShortCaption('KBS SocioEconomy Subsidy');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS SocioEconomy Subsidy');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_SocioEconomy_Subsidy"));
