 ...
 */
    ...
    class Info_KBS_Food_Nutrient_CompositionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`Info_KBS_Food_Nutrient_Composition`');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Food_Nutrient_Compositionssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Food_Nutrient_Compositionasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Food_Nutrient_Composition_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Food_Nutrient_CompositionGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Food_Nutrient_CompositionPage("Info_KBS_Food_Nutrient_Composition.php", "Info_KBS_Food_Nutrient_Composition", GetCurrentUserGrantForDataSource("Info_KBS_Food_Nutrient_Composition"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Food Nutrient Composition');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Food Nutrient Composition');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Food_Nutrient_Composition"));
