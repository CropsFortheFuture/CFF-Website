 ...
 */
    ...
    class Info_KBS_General_PartsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_part_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_General_Partsssearch', $this->dataset,
                array('cropID', 'part_bark', 'part_bulb', 'part_flower', 'part_fruits', 'part_grain', 'part_leaf', 'part_petiold', 'part_root', 'part_seed', 'part_stem', 'part_tuber', 'part_whole', 'part_wood', 'kbs_part_others'),
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_General_Partsasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_part_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_General_Parts_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_General_PartsGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_General_PartsPage("Info_KBS_General_Parts.php", "Info_KBS_General_Parts", GetCurrentUserGrantForDataSource("Info_KBS_General_Parts"), 'UTF-8');
        $Page->SetShortCaption('Info KBS General Parts');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS General Parts');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_General_Parts"));
