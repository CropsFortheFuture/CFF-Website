    ...
    class KBS_General_Growth_HabitPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_General_Growth_Habitssearch', $this->dataset,
                array('cropID', 'growth_habit_forb', 'growth_habit_graminoid', 'growth_habit_liana', 'growth_habit_lichenous', 'growth_habit_nonvascular', 'growth_habit_shrub', 'growth_habit_subshrub', 'growth_habit_tree', 'growth_habit_vine', 'kbs_gh_others'),
