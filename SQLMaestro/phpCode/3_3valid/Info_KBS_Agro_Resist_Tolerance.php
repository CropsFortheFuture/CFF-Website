 ...
 */
    ...
    class Info_KBS_Agro_Resist_TolerancePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`Info_KBS_Agro_Resist_Tolerance`');
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_resisttoler_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Agro_Resist_Tolerancessearch', $this->dataset,
                array('cropID', 'toler_disease', 'toler_drought', 'toler_extreme_alkal', 'toler_extreme_acid', 'toler_heat', 'toler_frost', 'toler_infertile_soil', 'toler_pest', 'toler_salinity', 'toler_shade', 'toler_waterlogging', 'toler_weed', 'kbs_resisttoler_others'),
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Resist_Toleranceasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_resisttoler_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Resist_Tolerance_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_Resist_ToleranceGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_Resist_TolerancePage("Info_KBS_Agro_Resist_Tolerance.php", "Info_KBS_Agro_Resist_Tolerance", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Resist_Tolerance"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Resist Tolerance');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Resist Tolerance');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Resist_Tolerance"));
