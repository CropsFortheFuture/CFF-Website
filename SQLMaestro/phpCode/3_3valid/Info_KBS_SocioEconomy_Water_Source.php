 ...
 */
    ...
    class Info_KBS_SocioEconomy_Water_SourcePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`Info_KBS_SocioEconomy_Water_Source`');
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_watersource_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_SocioEconomy_Water_Sourcessearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_SocioEconomy_Water_Sourceasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_watersource_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_SocioEconomy_Water_Source_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_SocioEconomy_Water_SourceGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_SocioEconomy_Water_SourcePage("Info_KBS_SocioEconomy_Water_Source.php", "Info_KBS_SocioEconomy_Water_Source", GetCurrentUserGrantForDataSource("Info_KBS_SocioEconomy_Water_Source"), 'UTF-8');
        $Page->SetShortCaption('Info KBS SocioEconomy Water Source');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS SocioEconomy Water Source');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_SocioEconomy_Water_Source"));
