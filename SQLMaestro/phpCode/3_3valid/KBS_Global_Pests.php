    ...
    class KBS_Global_PestsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Global_Pests`');
            $field = new IntegerField('pest_id');
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Global_Pestsssearch', $this->dataset,
                array('pest_id', 'pest_sci_name', 'pest_name', 'info_id'),
                array($this->RenderText('Pest Id'), $this->RenderText('Pest Sci Name'), $this->RenderText('Pest Name'), $this->RenderText('Info Id')),
                array(
