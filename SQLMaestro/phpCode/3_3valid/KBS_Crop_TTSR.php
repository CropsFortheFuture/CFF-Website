    ...
    class KBS_Crop_TTSRPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_TTSRssearch', $this->dataset,
                array('id', 'cropid', 'location_id', 'ttsr', 'image_path'),
                array($this->RenderText('Id'), $this->RenderText('Cropid'), $this->RenderText('Location Id'), $this->RenderText('Ttsr'), $this->RenderText('Image Path')),
                array(
