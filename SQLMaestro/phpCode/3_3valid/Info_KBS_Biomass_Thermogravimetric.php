 ...
 */
    ...
    class Info_KBS_Biomass_ThermogravimetricPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_biomthermograv_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Biomass_Thermogravimetricssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Biomass_Thermogravimetricasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_biomthermograv_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Biomass_Thermogravimetric_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Biomass_ThermogravimetricGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Biomass_ThermogravimetricPage("Info_KBS_Biomass_Thermogravimetric.php", "Info_KBS_Biomass_Thermogravimetric", GetCurrentUserGrantForDataSource("Info_KBS_Biomass_Thermogravimetric"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Biomass Thermogravimetric');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Biomass Thermogravimetric');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Biomass_Thermogravimetric"));
