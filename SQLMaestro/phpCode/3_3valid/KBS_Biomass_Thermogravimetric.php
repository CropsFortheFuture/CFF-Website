 ...
 */
    ...
    class KBS_Biomass_ThermogravimetricPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('biomass_cellulose_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_cellulose_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_cellulose_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_hemicellulose_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_hemicellulose_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_hemicellulose_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_lignin_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_lignin_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_lignin_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_thermo_moisture_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_thermo_moisture_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_thermo_moisture_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_oxygen_bomb_hhv_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_oxygen_bomb_hhv_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_oxygen_bomb_hhv_mean');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_biomthermograv_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Biomass_Thermogravimetricssearch', $this->dataset,
                array('cropID', 'biomass_cellulose_min', 'biomass_cellulose_max', 'biomass_cellulose_mean', 'biomass_hemicellulose_min', 'biomass_hemicellulose_max', 'biomass_hemicellulose_mean', 'biomass_lignin_min', 'biomass_lignin_max', 'biomass_lignin_mean', 'biomass_thermo_moisture_min', 'biomass_thermo_moisture_max', 'biomass_thermo_moisture_mean', 'biomass_oxygen_bomb_hhv_min', 'biomass_oxygen_bomb_hhv_max', 'biomass_oxygen_bomb_hhv_mean', 'kbs_biomthermograv_others'),
                array($this->RenderText('CropID'), $this->RenderText('Biomass Cellulose Min'), $this->RenderText('Biomass Cellulose Max'), $this->RenderText('Biomass Cellulose Mean'), $this->RenderText('Biomass Hemicellulose Min'), $this->RenderText('Biomass Hemicellulose Max'), $this->RenderText('Biomass Hemicellulose Mean'), $this->RenderText('Biomass Lignin Min'), $this->RenderText('Biomass Lignin Max'), $this->RenderText('Biomass Lignin Mean'), $this->RenderText('Biomass Thermo Moisture Min'), $this->RenderText('Biomass Thermo Moisture Max'), $this->RenderText('Biomass Thermo Moisture Mean'), $this->RenderText('Biomass Oxygen Bomb Hhv Min'), $this->RenderText('Biomass Oxygen Bomb Hhv Max'), $this->RenderText('Biomass Oxygen Bomb Hhv Mean'), $this->RenderText('Kbs Biomthermograv Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Biomass_Thermogravimetricasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_cellulose_min', $this->RenderText('Biomass Cellulose Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_cellulose_max', $this->RenderText('Biomass Cellulose Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_cellulose_mean', $this->RenderText('Biomass Cellulose Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_hemicellulose_min', $this->RenderText('Biomass Hemicellulose Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_hemicellulose_max', $this->RenderText('Biomass Hemicellulose Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_hemicellulose_mean', $this->RenderText('Biomass Hemicellulose Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_lignin_min', $this->RenderText('Biomass Lignin Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_lignin_max', $this->RenderText('Biomass Lignin Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_lignin_mean', $this->RenderText('Biomass Lignin Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_thermo_moisture_min', $this->RenderText('Biomass Thermo Moisture Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_thermo_moisture_max', $this->RenderText('Biomass Thermo Moisture Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_thermo_moisture_mean', $this->RenderText('Biomass Thermo Moisture Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_oxygen_bomb_hhv_min', $this->RenderText('Biomass Oxygen Bomb Hhv Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_oxygen_bomb_hhv_max', $this->RenderText('Biomass Oxygen Bomb Hhv Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_oxygen_bomb_hhv_mean', $this->RenderText('Biomass Oxygen Bomb Hhv Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_biomthermograv_others', $this->RenderText('Kbs Biomthermograv Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for biomass_cellulose_min field
            //
            $column = new TextViewColumn('biomass_cellulose_min', 'Biomass Cellulose Min', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for biomass_cellulose_max field
            //
            $column = new TextViewColumn('biomass_cellulose_max', 'Biomass Cellulose Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_cellulose_mean field
            //
            $column = new TextViewColumn('biomass_cellulose_mean', 'Biomass Cellulose Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_hemicellulose_min field
            //
            $column = new TextViewColumn('biomass_hemicellulose_min', 'Biomass Hemicellulose Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_hemicellulose_max field
            //
            $column = new TextViewColumn('biomass_hemicellulose_max', 'Biomass Hemicellulose Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_hemicellulose_mean field
            //
            $column = new TextViewColumn('biomass_hemicellulose_mean', 'Biomass Hemicellulose Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_lignin_min field
            //
            $column = new TextViewColumn('biomass_lignin_min', 'Biomass Lignin Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_lignin_max field
            //
            $column = new TextViewColumn('biomass_lignin_max', 'Biomass Lignin Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_lignin_mean field
            //
            $column = new TextViewColumn('biomass_lignin_mean', 'Biomass Lignin Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_thermo_moisture_min field
            //
            $column = new TextViewColumn('biomass_thermo_moisture_min', 'Biomass Thermo Moisture Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_thermo_moisture_max field
            //
            $column = new TextViewColumn('biomass_thermo_moisture_max', 'Biomass Thermo Moisture Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_thermo_moisture_mean field
            //
            $column = new TextViewColumn('biomass_thermo_moisture_mean', 'Biomass Thermo Moisture Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_oxygen_bomb_hhv_min field
            //
            $column = new TextViewColumn('biomass_oxygen_bomb_hhv_min', 'Biomass Oxygen Bomb Hhv Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_oxygen_bomb_hhv_max field
            //
            $column = new TextViewColumn('biomass_oxygen_bomb_hhv_max', 'Biomass Oxygen Bomb Hhv Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_oxygen_bomb_hhv_mean field
            //
            $column = new TextViewColumn('biomass_oxygen_bomb_hhv_mean', 'Biomass Oxygen Bomb Hhv Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for kbs_biomthermograv_others field
            //
            $column = new TextViewColumn('kbs_biomthermograv_others', 'Kbs Biomthermograv Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_ThermogravimetricGrid_kbs_biomthermograv_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_ThermogravimetricGrid_kbs_biomthermograv_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for biomass_cellulose_min field
            //
            $editor = new TextEdit('biomass_cellulose_min_edit');
            $editColumn = new CustomEditColumn('Biomass Cellulose Min', 'biomass_cellulose_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_cellulose_max field
            //
            $editor = new TextEdit('biomass_cellulose_max_edit');
            $editColumn = new CustomEditColumn('Biomass Cellulose Max', 'biomass_cellulose_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_cellulose_mean field
            //
            $editor = new TextEdit('biomass_cellulose_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Cellulose Mean', 'biomass_cellulose_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_hemicellulose_min field
            //
            $editor = new TextEdit('biomass_hemicellulose_min_edit');
            $editColumn = new CustomEditColumn('Biomass Hemicellulose Min', 'biomass_hemicellulose_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_hemicellulose_max field
            //
            $editor = new TextEdit('biomass_hemicellulose_max_edit');
            $editColumn = new CustomEditColumn('Biomass Hemicellulose Max', 'biomass_hemicellulose_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_hemicellulose_mean field
            //
            $editor = new TextEdit('biomass_hemicellulose_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Hemicellulose Mean', 'biomass_hemicellulose_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_lignin_min field
            //
            $editor = new TextEdit('biomass_lignin_min_edit');
            $editColumn = new CustomEditColumn('Biomass Lignin Min', 'biomass_lignin_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_lignin_max field
            //
            $editor = new TextEdit('biomass_lignin_max_edit');
            $editColumn = new CustomEditColumn('Biomass Lignin Max', 'biomass_lignin_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_lignin_mean field
            //
            $editor = new TextEdit('biomass_lignin_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Lignin Mean', 'biomass_lignin_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_thermo_moisture_min field
            //
            $editor = new TextEdit('biomass_thermo_moisture_min_edit');
            $editColumn = new CustomEditColumn('Biomass Thermo Moisture Min', 'biomass_thermo_moisture_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_thermo_moisture_max field
            //
            $editor = new TextEdit('biomass_thermo_moisture_max_edit');
            $editColumn = new CustomEditColumn('Biomass Thermo Moisture Max', 'biomass_thermo_moisture_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_thermo_moisture_mean field
            //
            $editor = new TextEdit('biomass_thermo_moisture_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Thermo Moisture Mean', 'biomass_thermo_moisture_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_oxygen_bomb_hhv_min field
            //
            $editor = new TextEdit('biomass_oxygen_bomb_hhv_min_edit');
            $editColumn = new CustomEditColumn('Biomass Oxygen Bomb Hhv Min', 'biomass_oxygen_bomb_hhv_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_oxygen_bomb_hhv_max field
            //
            $editor = new TextEdit('biomass_oxygen_bomb_hhv_max_edit');
            $editColumn = new CustomEditColumn('Biomass Oxygen Bomb Hhv Max', 'biomass_oxygen_bomb_hhv_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_oxygen_bomb_hhv_mean field
            //
            $editor = new TextEdit('biomass_oxygen_bomb_hhv_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Oxygen Bomb Hhv Mean', 'biomass_oxygen_bomb_hhv_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_biomthermograv_others field
            //
            $editor = new TextAreaEdit('kbs_biomthermograv_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Biomthermograv Others', 'kbs_biomthermograv_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Biomass_Thermogravimetric_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Biomass_ThermogravimetricGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_biomthermograv_others', 'Kbs Biomthermograv Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_ThermogravimetricGrid_kbs_biomthermograv_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_biomthermograv_others field
            //
            $column = new TextViewColumn('kbs_biomthermograv_others', 'Kbs Biomthermograv Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_ThermogravimetricGrid_kbs_biomthermograv_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Biomass_ThermogravimetricPage("KBS_Biomass_Thermogravimetric.php", "KBS_Biomass_Thermogravimetric", GetCurrentUserGrantForDataSource("KBS_Biomass_Thermogravimetric"), 'UTF-8');
        $Page->SetShortCaption('KBS Biomass Thermogravimetric');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Biomass Thermogravimetric');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Biomass_Thermogravimetric"));
