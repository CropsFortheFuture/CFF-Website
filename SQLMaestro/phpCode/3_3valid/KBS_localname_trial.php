    ...
    class KBS_localname_trialPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_localname_trialssearch', $this->dataset,
                array('localname_id', 'cropID', 'localname', 'localname_countryname', 'localname_ref', 'country_id'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('localname_id', $this->RenderText('Localname Id')));
        ...
        {
            //
            // View column for localname_id field
            //
            $column = new TextViewColumn('localname_id', 'Localname Id', $this->dataset);
