    ...
    class KBS_Biomass_OutputPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Biomass_Outputssearch', $this->dataset,
                array('cropID', 'biomass_power_output_min', 'biomass_power_output_max', 'biomass_power_output_mean', 'biomass_total_min', 'biomass_total_max', 'biomass_total_mean', 'kbs_biomoupt_others'),
