 ...
 */
    ...
    class Info_KBS_Agro_SeasonPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_season_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Agro_Seasonssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Seasonasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_season_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Season_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_SeasonGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_SeasonPage("Info_KBS_Agro_Season.php", "Info_KBS_Agro_Season", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Season"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Season');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Season');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Season"));
