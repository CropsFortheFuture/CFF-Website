    ...
    class KBS_Agro_Cropping_SystemPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Agro_Cropping_Systemssearch', $this->dataset,
                array('id', 'cropID', 'location_id', 'crop_system_intercrop', 'crop_system_monocrop', 'KBS_Cropping_Systemcol', 'crop_system_rotate', 'crop_system_alley', 'crop_system_multitier', 'crop_system_mechan_high', 'crop_system_mechan_medium', 'crop_system_mechan_low', 'crop_system_labour_high', 'crop_system_labour_medium', 'crop_system_labour_low', 'kbs_cropsys_others'),
                array($this->RenderText('Id'), $this->RenderText('CropID'), $this->RenderText('Location Id'), $this->RenderText('Crop System Intercrop'), $this->RenderText('Crop System Monocrop'), $this->RenderText('KBS Cropping Systemcol'), $this->RenderText('Crop System Rotate'), $this->RenderText('Crop System Alley'), $this->RenderText('Crop System Multitier'), $this->RenderText('Crop System Mechan High'), $this->RenderText('Crop System Mechan Medium'), $this->RenderText('Crop System Mechan Low'), $this->RenderText('Crop System Labour High'), $this->RenderText('Crop System Labour Medium'), $this->RenderText('Crop System Labour Low'), $this->RenderText('Kbs Cropsys Others')),
                array(
