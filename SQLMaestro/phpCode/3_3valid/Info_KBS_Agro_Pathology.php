 ...
 */
    ...
    class Info_KBS_Agro_PathologyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_patho_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Pathologyasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_patho_others', $this->RenderText('Kbs Patho Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for kbs_patho_others field
            //
            $column = new TextViewColumn('kbs_patho_others', 'Kbs Patho Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for kbs_patho_others field
            //
            $editor = new TextEdit('kbs_patho_others_edit');
            $editColumn = new CustomEditColumn('Kbs Patho Others', 'kbs_patho_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Pathology_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_PathologyGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_PathologyPage("Info_KBS_Agro_Pathology.php", "Info_KBS_Agro_Pathology", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Pathology"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Pathology');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Pathology');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Pathology"));
