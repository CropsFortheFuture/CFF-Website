 ...
 */
    ...
    class Info_KBS_Agro_Agronomic_PracticesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`Info_KBS_Agro_Agronomic_Practices`');
            ...
            $this->dataset->AddField($field, false);
            $field = new IntegerField('kbs_agropract_others');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Info_KBS_Agro_Agronomic_Practicesssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Info_KBS_Agro_Agronomic_Practicesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('kbs_agropract_others_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'Info_KBS_Agro_Agronomic_Practices_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'Info_KBS_Agro_Agronomic_PracticesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new Info_KBS_Agro_Agronomic_PracticesPage("Info_KBS_Agro_Agronomic_Practices.php", "Info_KBS_Agro_Agronomic_Practices", GetCurrentUserGrantForDataSource("Info_KBS_Agro_Agronomic_Practices"), 'UTF-8');
        $Page->SetShortCaption('Info KBS Agro Agronomic Practices');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Info KBS Agro Agronomic Practices');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Info_KBS_Agro_Agronomic_Practices"));
