    ...
    class KBS_Crop_StatPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Statssearch', $this->dataset,
                array('statID', 'cropID_name_var_lndrce', 'area_cultivated_max', 'area_cultivated_mean', 'area_cultivated_min', 'area_harvst_max', 'area_harvst_mean', 'area_harvst_min', 'yield_max', 'yield_mean', 'yield_min', 'kbs_stat_others', 'metadata_id'),
                array($this->RenderText('StatID'), $this->RenderText('CropID'), $this->RenderText('Area Cultivated Max'), $this->RenderText('Area Cultivated Mean'), $this->RenderText('Area Cultivated Min'), $this->RenderText('Area Harvst Max'), $this->RenderText('Area Harvst Mean'), $this->RenderText('Area Harvst Min'), $this->RenderText('Yield Max'), $this->RenderText('Yield Mean'), $this->RenderText('Yield Min'), $this->RenderText('Kbs Stat Others'), $this->RenderText('Metadata Id')),
                array(
