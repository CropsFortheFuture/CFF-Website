 ...
 */
    ...
    class KBS_MetadataPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('acc_flag', 'KBS_Global_Accuracy_Color', new IntegerField('id', null, null, true), new StringField('flag_color', 'acc_flag_flag_color', 'acc_flag_flag_color_KBS_Global_Accuracy_Color'), 'acc_flag_flag_color_KBS_Global_Accuracy_Color');
            $this->dataset->AddLookupField('approval_flag', 'KBS_Global_Accuracy_Color', new IntegerField('id', null, null, true), new StringField('flag_color', 'approval_flag_flag_color', 'approval_flag_flag_color_KBS_Global_Accuracy_Color'), 'approval_flag_flag_color_KBS_Global_Accuracy_Color');
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Metadatassearch', $this->dataset,
                array('id', 'cropid_name_var_lndrce', 'location_id_google_address', 'ref1', 'src1', 'ref2', 'src2', 'ref3', 'src3', 'ref4', 'src4', 'ref5', 'src5', 'ref6', 'src6', 'ref7', 'src7', 'ref8', 'src8', 'ref9', 'src9', 'ref10', 'src10', 'note', 'acc_flag_flag_color', 'approval_flag_flag_color', 'contributor', 'coverage', 'creator', 'date', 'description', 'format', 'identifier', 'language', 'publisher', 'relation', 'rights', 'source', 'subject', 'title', 'type', 'image', 'document', 'table_col_id_table_col_name'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Accuracy_Color`');
            $field = new IntegerField('id', null, null, true);
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, true);
            $field = new StringField('flag_color');
            $lookupDataset->AddField($field, false);
            $lookupDataset->setOrderByField('flag_color', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('acc_flag', $this->RenderText('Acc Flag'), $lookupDataset, 'id', 'flag_color', false, 8));
            ...
            $lookupDataset->AddField($field, false);
            $lookupDataset->setOrderByField('flag_color', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('approval_flag', $this->RenderText('Approval Flag'), $lookupDataset, 'id', 'flag_color', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for flag_color field
            //
            $column = new TextViewColumn('acc_flag_flag_color', 'Acc Flag', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            // View column for flag_color field
            //
            $column = new TextViewColumn('approval_flag_flag_color', 'Approval Flag', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new ImageViewColumn('image', 'Image', $this->dataset, false, 'KBS_MetadataGrid_image_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            // View column for image field
            //
            $column = new ImageViewColumn('image', 'Image', $this->dataset, false, 'KBS_MetadataGrid_image_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('acc_flag_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Accuracy_Color`');
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'acc_flag', 
                $editor, 
                $this->dataset, 'id', 'flag_color', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new ComboBox('approval_flag_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Accuracy_Color`');
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            // View column for image field
            //
            $column = new ImageViewColumn('image', 'Image', $this->dataset, false, 'KBS_MetadataGrid_image_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            // View column for image field
            //
            $column = new ImageViewColumn('image', 'Image', $this->dataset, false, 'KBS_MetadataGrid_image_handler_export');
            $grid->AddExportColumn($column);
        ...
        protected function CreateGrid()
        {
            ...
            $handler = new ImageHTTPHandler($this->dataset, 'image', 'KBS_MetadataGrid_image_handler_list', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new ImageHTTPHandler($this->dataset, 'image', 'KBS_MetadataGrid_image_handler_view', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            $handler = new DownloadHTTPHandler($this->dataset, 'document', 'document_handler', '', '', true);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new ImageHTTPHandler($this->dataset, 'image', 'KBS_MetadataGrid_image_handler_print', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            $handler = new DownloadHTTPHandler($this->dataset, 'document', 'document_handler', '', '', true);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
