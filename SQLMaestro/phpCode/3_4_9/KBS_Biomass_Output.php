 ...
 */
    ...
    class KBS_Biomass_OutputPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('biomass_power_output_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_power_output_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_power_output_mean');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_total_min');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_total_max');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('biomass_total_mean');
            $this->dataset->AddField($field, false);
            $field = new StringField('kbs_biomoupt_others');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Biomass_Outputssearch', $this->dataset,
                array('cropID_name_var_lndrce', 'biomass_power_output_min', 'biomass_power_output_max', 'biomass_power_output_mean', 'biomass_total_min', 'biomass_total_max', 'biomass_total_mean', 'kbs_biomoupt_others'),
                array($this->RenderText('CropID'), $this->RenderText('Biomass Power Output Min'), $this->RenderText('Biomass Power Output Max'), $this->RenderText('Biomass Power Output Mean'), $this->RenderText('Biomass Total Min'), $this->RenderText('Biomass Total Max'), $this->RenderText('Biomass Total Mean'), $this->RenderText('Kbs Biomoupt Others')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Biomass_Outputasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_power_output_min', $this->RenderText('Biomass Power Output Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_power_output_max', $this->RenderText('Biomass Power Output Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_power_output_mean', $this->RenderText('Biomass Power Output Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_total_min', $this->RenderText('Biomass Total Min')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_total_max', $this->RenderText('Biomass Total Max')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('biomass_total_mean', $this->RenderText('Biomass Total Mean')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('kbs_biomoupt_others', $this->RenderText('Kbs Biomoupt Others')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for biomass_power_output_min field
            //
            $column = new TextViewColumn('biomass_power_output_min', 'Biomass Power Output Min', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for biomass_power_output_max field
            //
            $column = new TextViewColumn('biomass_power_output_max', 'Biomass Power Output Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_power_output_mean field
            //
            $column = new TextViewColumn('biomass_power_output_mean', 'Biomass Power Output Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_total_min field
            //
            $column = new TextViewColumn('biomass_total_min', 'Biomass Total Min', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_total_max field
            //
            $column = new TextViewColumn('biomass_total_max', 'Biomass Total Max', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for biomass_total_mean field
            //
            $column = new TextViewColumn('biomass_total_mean', 'Biomass Total Mean', $this->dataset);
            $column->SetOrderable(true);
            $column = new NumberFormatValueViewColumnDecorator($column, 4, ',', '.');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            // View column for kbs_biomoupt_others field
            //
            $column = new TextViewColumn('kbs_biomoupt_others', 'Kbs Biomoupt Others', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_OutputGrid_kbs_biomoupt_others_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Biomass_OutputGrid_kbs_biomoupt_others_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for biomass_power_output_min field
            //
            $editor = new TextEdit('biomass_power_output_min_edit');
            $editColumn = new CustomEditColumn('Biomass Power Output Min', 'biomass_power_output_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_power_output_max field
            //
            $editor = new TextEdit('biomass_power_output_max_edit');
            $editColumn = new CustomEditColumn('Biomass Power Output Max', 'biomass_power_output_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_power_output_mean field
            //
            $editor = new TextEdit('biomass_power_output_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Power Output Mean', 'biomass_power_output_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_total_min field
            //
            $editor = new TextEdit('biomass_total_min_edit');
            $editColumn = new CustomEditColumn('Biomass Total Min', 'biomass_total_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_total_max field
            //
            $editor = new TextEdit('biomass_total_max_edit');
            $editColumn = new CustomEditColumn('Biomass Total Max', 'biomass_total_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for biomass_total_mean field
            //
            $editor = new TextEdit('biomass_total_mean_edit');
            $editColumn = new CustomEditColumn('Biomass Total Mean', 'biomass_total_mean', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for kbs_biomoupt_others field
            //
            $editor = new TextAreaEdit('kbs_biomoupt_others_edit', 50, 8);
            $editColumn = new CustomEditColumn('Kbs Biomoupt Others', 'kbs_biomoupt_others', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Biomass_Output_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Biomass_OutputGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('kbs_biomoupt_others', 'Kbs Biomoupt Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_OutputGrid_kbs_biomoupt_others_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for kbs_biomoupt_others field
            //
            $column = new TextViewColumn('kbs_biomoupt_others', 'Kbs Biomoupt Others', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Biomass_OutputGrid_kbs_biomoupt_others_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Biomass_OutputPage("KBS_Biomass_Output.php", "KBS_Biomass_Output", GetCurrentUserGrantForDataSource("KBS_Biomass_Output"), 'UTF-8');
        $Page->SetShortCaption('KBS Biomass Output');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Biomass Output');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Biomass_Output"));
