...
{
    $result = array('GENERAL', 'Agro', 'Food', 'Biomass', 'SocioEconomy', 'Crop Specific', 'Crop Metadata', 'Global Info', 'Aquacrop', 'Ecocrop', 'FPI');
    return $result;
}
...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Food Plants International', 'short_caption' => 'Food Plants International', 'filename' => 'food_plants_international.php', 'name' => 'food_plants_international', 'group_name' => 'FPI', 'add_separator' => false);
