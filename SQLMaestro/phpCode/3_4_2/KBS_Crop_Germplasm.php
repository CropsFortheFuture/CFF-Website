 ...
 */
    ...
    class KBS_Crop_GermplasmPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`KBS_Crop_Germplasm`');
            $field = new IntegerField('germplasm_id', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('institute_id');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('cropID');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('germp_inst_name');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_type_line');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_type_landrce');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_type_genotype');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_type_cross');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_no_accessions');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('germp_field_data_avlble');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('metadata_id');
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('institute_id', 'KBS_Global_Institute', new IntegerField('institute_id', null, null, true), new StringField('institute_name', 'institute_id_institute_name', 'institute_id_institute_name_KBS_Global_Institute'), 'institute_id_institute_name_KBS_Global_Institute');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Germplasmssearch', $this->dataset,
                array('germplasm_id', 'institute_id_institute_name', 'cropID_name_var_lndrce', 'germp_inst_name', 'germp_type_line', 'germp_type_landrce', 'germp_type_genotype', 'germp_type_cross', 'germp_no_accessions', 'germp_field_data_avlble', 'metadata_id'),
                array($this->RenderText('Germplasm Id'), $this->RenderText('Institute Id'), $this->RenderText('CropID'), $this->RenderText('Germp Inst Name'), $this->RenderText('Germp Type Line'), $this->RenderText('Germp Type Landrce'), $this->RenderText('Germp Type Genotype'), $this->RenderText('Germp Type Cross'), $this->RenderText('Germp No Accessions'), $this->RenderText('Germp Field Data Avlble'), $this->RenderText('Metadata Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('KBS_Crop_Germplasmasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germplasm_id', $this->RenderText('Germplasm Id')));
            
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Institute`');
            $field = new IntegerField('institute_id', null, null, true);
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, true);
            $field = new StringField('institute_name');
            $lookupDataset->AddField($field, false);
            $field = new IntegerField('metadata_id');
            $lookupDataset->AddField($field, false);
            $lookupDataset->setOrderByField('institute_name', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('institute_id', $this->RenderText('Institute Id'), $lookupDataset, 'institute_id', 'institute_name', false, 8));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_inst_name', $this->RenderText('Germp Inst Name')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_type_line', $this->RenderText('Germp Type Line')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_type_landrce', $this->RenderText('Germp Type Landrce')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_type_genotype', $this->RenderText('Germp Type Genotype')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_type_cross', $this->RenderText('Germp Type Cross')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_no_accessions', $this->RenderText('Germp No Accessions')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('germp_field_data_avlble', $this->RenderText('Germp Field Data Avlble')));
        ...
        {
            //
            // View column for germplasm_id field
            //
            $column = new TextViewColumn('germplasm_id', 'Germplasm Id', $this->dataset);
            ...
            //
            $column = new TextViewColumn('institute_id_institute_name', 'Institute Id', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_inst_name field
            //
            $column = new TextViewColumn('germp_inst_name', 'Germp Inst Name', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_GermplasmGrid_germp_inst_name_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for germp_type_line field
            //
            $column = new TextViewColumn('germp_type_line', 'Germp Type Line', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_type_landrce field
            //
            $column = new TextViewColumn('germp_type_landrce', 'Germp Type Landrce', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_type_genotype field
            //
            $column = new TextViewColumn('germp_type_genotype', 'Germp Type Genotype', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_type_cross field
            //
            $column = new TextViewColumn('germp_type_cross', 'Germp Type Cross', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_no_accessions field
            //
            $column = new TextViewColumn('germp_no_accessions', 'Germp No Accessions', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            // View column for germp_field_data_avlble field
            //
            $column = new TextViewColumn('germp_field_data_avlble', 'Germp Field Data Avlble', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('KBS_Crop_GermplasmGrid_germp_inst_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        {
            //
            // Edit column for germplasm_id field
            //
            $editor = new TextEdit('germplasm_id_edit');
            $editColumn = new CustomEditColumn('Germplasm Id', 'germplasm_id', $editor, $this->dataset);
            ...
            //
            // Edit column for institute_id field
            //
            $editor = new ComboBox('institute_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`KBS_Global_Institute`');
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'institute_id', 
                $editor, 
                $this->dataset, 'institute_id', 'institute_name', $lookupDataset);
            ...
            //
            // Edit column for germp_inst_name field
            //
            $editor = new TextEdit('germp_inst_name_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Germp Inst Name', 'germp_inst_name', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_type_line field
            //
            $editor = new TextEdit('germp_type_line_edit');
            $editColumn = new CustomEditColumn('Germp Type Line', 'germp_type_line', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_type_landrce field
            //
            $editor = new TextEdit('germp_type_landrce_edit');
            $editColumn = new CustomEditColumn('Germp Type Landrce', 'germp_type_landrce', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_type_genotype field
            //
            $editor = new TextEdit('germp_type_genotype_edit');
            $editColumn = new CustomEditColumn('Germp Type Genotype', 'germp_type_genotype', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_type_cross field
            //
            $editor = new TextEdit('germp_type_cross_edit');
            $editColumn = new CustomEditColumn('Germp Type Cross', 'germp_type_cross', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_no_accessions field
            //
            $editor = new TextEdit('germp_no_accessions_edit');
            $editColumn = new CustomEditColumn('Germp No Accessions', 'germp_no_accessions', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for germp_field_data_avlble field
            //
            $editor = new TextEdit('germp_field_data_avlble_edit');
            $editColumn = new CustomEditColumn('Germp Field Data Avlble', 'germp_field_data_avlble', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'KBS_Crop_Germplasm_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'KBS_Crop_GermplasmGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('germp_inst_name', 'Germp Inst Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_GermplasmGrid_germp_inst_name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for germp_inst_name field
            //
            $column = new TextViewColumn('germp_inst_name', 'Germp Inst Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'KBS_Crop_GermplasmGrid_germp_inst_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new KBS_Crop_GermplasmPage("KBS_Crop_Germplasm.php", "KBS_Crop_Germplasm", GetCurrentUserGrantForDataSource("KBS_Crop_Germplasm"), 'UTF-8');
        $Page->SetShortCaption('KBS Crop Germplasm');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('KBS Crop Germplasm');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("KBS_Crop_Germplasm"));
