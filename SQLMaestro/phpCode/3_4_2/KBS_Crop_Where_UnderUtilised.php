 ...
 */
    ...
    class KBS_Crop_Where_UnderUtilisedPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('where_underUtilised_id', null, null, true);
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Crop_Where_UnderUtilisedssearch', $this->dataset,
                array('where_underUtilised_id', 'cropID_name_var_lndrce', 'location_id', 'metadata_id'),
                array($this->RenderText('Where UnderUtilised Id'), $this->RenderText('CropID'), $this->RenderText('Location Id'), $this->RenderText('Metadata Id')),
                array(
