    ...
    class KBS_Agro_Cropping_SystemPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('KBS_Agro_Cropping_Systemssearch', $this->dataset,
                array('id', 'cropID_name_var_lndrce', 'location_id', 'crop_system_intercrop', 'crop_system_monocrop', 'KBS_Cropping_Systemcol', 'crop_system_mixed', 'crop_system_alley', 'crop_system_multitier', 'crop_system_mechan_high', 'crop_system_mechan_medium', 'crop_system_mechan_low', 'crop_system_labour_high', 'crop_system_labour_medium', 'crop_system_labour_low', 'kbs_cropsys_others'),
